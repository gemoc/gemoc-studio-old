 ...
 */
public class PartBroughtToTop extends AbstractPartChange {

	/**
	 * Constructor.
	 * 
	 * @param part
	 *            the brought to top {@link IWorkbenchPartReference}
	 */
	public PartBroughtToTop(IWorkbenchPartReference part) {
		super(part);
	}
