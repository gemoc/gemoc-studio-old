 ...
 * <ul>
 * <li>{@link fr.obeo.dsl.workspace.impl.ResourceImpl#getName <em>Name</em>}</li>
 * <li>{@link fr.obeo.dsl.workspace.impl.ResourceImpl#getFullpath <em>Fullpath</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class ResourceImpl extends EObjectImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return WorkspacePackage.Literals.RESOURCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkspacePackage.RESOURCE__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WorkspacePackage.RESOURCE__NAME:
				return getName();
			case WorkspacePackage.RESOURCE__FULLPATH:
				return getFullpath();
		}
