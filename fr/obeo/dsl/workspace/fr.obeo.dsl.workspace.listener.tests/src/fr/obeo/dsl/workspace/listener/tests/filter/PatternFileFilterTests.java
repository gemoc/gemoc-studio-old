...
import fr.obeo.dsl.workspace.listener.filter.PatternFileFilter;
...
/**
 * Tests the {@link PatternFileFilter} class.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class PatternFileFilterTests {

	/**
	 * Tests {@link PatternFileFilter#keep(fr.obeo.dsl.workspace.listener.change.IChange)} with
	 * {@link ResourceAdded} with a kept {@link IFile}.
	 */
	@Test
	public void keepAddFileKept() {
		final PatternFileFilter filter = new PatternFileFilter(".*\\.keep");
