...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.plugin.Plugin} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class PluginItemProvider extends BundleItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    /**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plugin_require_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plugin_require_feature", "_UI_Plugin_type"),
				 PluginPackage.Literals.PLUGIN__REQUIRE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PluginPackage.Literals.PLUGIN__EXTENSIONS,
				 true,
				 false,
				 true,
				 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PluginPackage.Literals.PLUGIN__OWNED_EXTENSION_POINTS);
			childrenFeatures.add(PluginPackage.Literals.PLUGIN__EXPORTED_PACKAGES);
		}
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Plugin_type") : label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PluginPackage.Literals.PLUGIN__OWNED_EXTENSION_POINTS,
				 PluginFactory.eINSTANCE.createExtensionPoint()));

		newChildDescriptors.add
			(createChildParameter
				(PluginPackage.Literals.PLUGIN__EXPORTED_PACKAGES,
				 PluginFactory.eINSTANCE.createPackage()));
	}
