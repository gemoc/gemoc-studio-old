...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.plugin.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PluginPackage.Literals.BUNDLE__NAME,
				 true,
				 false,
				 false,
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_description_feature", "_UI_Bundle_type"),
				 PluginPackage.Literals.BUNDLE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
