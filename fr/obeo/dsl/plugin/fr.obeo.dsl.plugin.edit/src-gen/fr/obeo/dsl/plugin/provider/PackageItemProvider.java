...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.plugin.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PluginPackage.Literals.PACKAGE__NAME,
				 true,
				 false,
				 false,
    ...
    public String getText(Object object) {
		String label = ((fr.obeo.dsl.plugin.Package)object).getName();
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(fr.obeo.dsl.plugin.Package.class)) {
			case PluginPackage.PACKAGE__NAME:
