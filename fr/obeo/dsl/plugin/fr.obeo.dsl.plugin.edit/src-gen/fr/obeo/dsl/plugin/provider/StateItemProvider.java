...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.plugin.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PluginPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_eClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_eClass_feature", "_UI_State_type"),
				 PluginPackage.Literals.STATE__ECLASS,
				 true,
				 false,
				 true,
				 null,
