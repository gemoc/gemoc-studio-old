...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.plugin.LogicalArchitecture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicalArchitectureItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PluginPackage.Literals.LOGICAL_ARCHITECTURE__COMPONENTS);
			childrenFeatures.add(PluginPackage.Literals.LOGICAL_ARCHITECTURE__STATES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LogicalArchitecture"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_LogicalArchitecture_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PluginPackage.Literals.LOGICAL_ARCHITECTURE__COMPONENTS,
				 PluginFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(PluginPackage.Literals.LOGICAL_ARCHITECTURE__STATES,
				 PluginFactory.eINSTANCE.createState()));
	}
