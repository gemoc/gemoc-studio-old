 ...
 * 
 */
package fr.obeo.dsl.sirius.animation.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.obeo.dsl.sirius.animation.AnimationPackage
 * @generated
 */
public class AnimationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnimationPackage.ANIMATION_TARGET: {
				AnimationTarget animationTarget = (AnimationTarget)theEObject;
				T result = caseAnimationTarget(animationTarget);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnimationPackage.STACK_FRAME: {
				StackFrame stackFrame = (StackFrame)theEObject;
				T result = caseStackFrame(stackFrame);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnimationPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnimationPackage.THREAD: {
				fr.obeo.dsl.sirius.animation.Thread thread = (fr.obeo.dsl.sirius.animation.Thread)theEObject;
				T result = caseThread(thread);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnimationPackage.CURRENT_SESSIONS: {
				CurrentSessions currentSessions = (CurrentSessions)theEObject;
				T result = caseCurrentSessions(currentSessions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAnimationTarget(AnimationTarget object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseThread(fr.obeo.dsl.sirius.animation.Thread object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Current Sessions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Current Sessions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCurrentSessions(CurrentSessions object) {
		return null;
	}
