...
public class AnimationAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnimationSwitch<Adapter> modelSwitch =
		new AnimationSwitch<Adapter>() {
			@Override
			public Adapter caseAnimationTarget(AnimationTarget object) {
				return createAnimationTargetAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseThread(fr.obeo.dsl.sirius.animation.Thread object) {
				return createThreadAdapter();
			}
			@Override
			public Adapter caseCurrentSessions(CurrentSessions object) {
				return createCurrentSessionsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.obeo.dsl.sirius.animation.AnimationTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.obeo.dsl.sirius.animation.StackFrame <em>Stack Frame</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.obeo.dsl.sirius.animation.Variable <em>Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.obeo.dsl.sirius.animation.Thread <em>Thread</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.obeo.dsl.sirius.animation.CurrentSessions <em>Current Sessions</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
