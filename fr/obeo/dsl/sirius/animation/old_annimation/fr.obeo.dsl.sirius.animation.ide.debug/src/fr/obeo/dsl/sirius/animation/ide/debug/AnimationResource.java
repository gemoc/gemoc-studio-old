...
public class AnimationResource extends ResourceImpl {

	public AnimationResource(URI createURI) {
		super(createURI);
	}

	public CurrentSessions getRootObject() {
		return (CurrentSessions) getContents().get(0);
	}
