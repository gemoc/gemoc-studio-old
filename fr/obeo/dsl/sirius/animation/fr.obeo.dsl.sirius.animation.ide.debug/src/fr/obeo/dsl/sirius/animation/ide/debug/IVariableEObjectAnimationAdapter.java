...
public class IVariableEObjectAnimationAdapter extends
	...
	private EObjectVariableWrapper getHost() {
		return (EObjectVariableWrapper) getTarget();
	}
	...
	public String getName() throws DebugException {
		String name = "";
		EObject host = getHost().getWrapped();
