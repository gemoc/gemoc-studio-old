 ...
 * {@link fr.obeo.dsl.sirius.animation.Thread} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ThreadItemProvider extends ItemProviderAdapter implements
	...
	protected void addTopStackFramePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Thread_topStackFrame_feature", "_UI_Thread_type"),
				AnimationPackage.Literals.THREAD__TOP_STACK_FRAME, true, false,
				true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Thread_name_feature", "_UI_Thread_type"),
				AnimationPackage.Literals.THREAD__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(AnimationPackage.Literals.THREAD__STACK_FRAMES);
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(fr.obeo.dsl.sirius.animation.Thread.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						...
						ContributionFactory.eINSTANCE
								.createIgnoreFeatureContribution()));
		...
		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ContributionFactory.eINSTANCE
								.createResetFeatureContribution()));
		...
		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ContributionFactory.eINSTANCE
								.createComputedEObjectReference()));
		...
		newChildDescriptors.add(createChildParameter(
				AnimationPackage.Literals.THREAD__DATA,
				ViewpointFactory.eINSTANCE
						.createComputedStyleDescriptionRegistry()));

		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ViewpointFactory.eINSTANCE
								.create(ViewpointPackage.Literals.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT)));

		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ViewpointFactory.eINSTANCE
								.create(ViewpointPackage.Literals.MODEL_ELEMENT2_VIEW_VARIABLE)));

		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ViewpointFactory.eINSTANCE
								.create(ViewpointPackage.Literals.VIEW_VARIABLE2_CONTAINER_VARIABLE)));

		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						ViewpointFactory.eINSTANCE
								.create(ViewpointPackage.Literals.CONTAINER_VARIABLE2_STYLE_DESCRIPTION)));
		...
		newChildDescriptors
				.add(createChildParameter(
						AnimationPackage.Literals.THREAD__DATA,
						DescriptionFactory.eINSTANCE
								.createMetamodelExtensionSetting()));
		...
		newChildDescriptors.add(createChildParameter(
				AnimationPackage.Literals.THREAD__DATA,
				DescriptionFactory.eINSTANCE
						.createVSMElementCustomizationReuse()));
		...
		newChildDescriptors.add(createChildParameter(
				AnimationPackage.Literals.THREAD__DATA, ToolFactory.eINSTANCE
						.createPaneBasedSelectionWizardDescription()));
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == AnimationPackage.Literals.THREAD__STACK_FRAMES
