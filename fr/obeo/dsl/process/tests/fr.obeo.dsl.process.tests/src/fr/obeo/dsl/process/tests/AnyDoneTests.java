...
/**
 * Tests the class {@link AnyDone}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class AnyDoneTests {
	...
	public void checkNoTasks() {
		final AnyDone expression = ProcessPackage.eINSTANCE.getProcessFactory().createAnyDone();
