...
/**
 * This is the action bar contributor for the Process model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class ProcessActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ProcessEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
