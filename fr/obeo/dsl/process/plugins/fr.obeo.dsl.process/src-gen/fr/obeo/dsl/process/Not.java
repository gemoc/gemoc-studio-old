 ...
 * <!-- begin-model-doc --> {@link Not#check() Checks} returns <code>true</code> if its
 * {@link Not#getExpression() expression} is <code>false</code>, <code>false</code> otherwise. <!--
 * end-model-doc -->
 * <p>
...
public interface Not extends Expression {
	...
	/**
	 * Sets the value of the '{@link fr.obeo.dsl.process.Not#getExpression <em>Expression</em>}' containment
