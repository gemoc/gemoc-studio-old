 ...
 * <ul>
 *   <li>{@link tfsmextended.impl.TemporalGuardImpl#getOnClock <em>On Clock</em>}</li>
 *   <li>{@link tfsmextended.impl.TemporalGuardImpl#getAfterDuration <em>After Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemporalGuardImpl extends GuardImpl implements TemporalGuard {
	...
	protected EClass eStaticClass() {
		return TfsmextendedPackage.Literals.TEMPORAL_GUARD;
	}
		...
		if (onClock != null && onClock.eIsProxy()) {
			...
			if (onClock != oldOnClock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmextendedPackage.TEMPORAL_GUARD__ON_CLOCK, oldOnClock, onClock));
			}
		}
		return onClock;
	}
	...
	public void setOnClock(FSMClock newOnClock) {
		...
		onClock = newOnClock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmextendedPackage.TEMPORAL_GUARD__ON_CLOCK, oldOnClock, onClock));
	}
	...
	public void setAfterDuration(int newAfterDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmextendedPackage.TEMPORAL_GUARD__AFTER_DURATION, oldAfterDuration, afterDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmextendedPackage.TEMPORAL_GUARD__ON_CLOCK:
				if (resolve) return getOnClock();
				return basicGetOnClock();
			case TfsmextendedPackage.TEMPORAL_GUARD__AFTER_DURATION:
