 ...
 * <ul>
 *   <li>{@link tfsmextended.impl.FSMEventImpl#getSollicitingTransitions <em>Solliciting Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FSMEventImpl extends NamedElementImpl implements FSMEvent {
	...
	public EList<Transition> getSollicitingTransitions() {
		if (sollicitingTransitions == null) {
			sollicitingTransitions = new EObjectResolvingEList<Transition>(Transition.class, this, TfsmextendedPackage.FSM_EVENT__SOLLICITING_TRANSITIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmextendedPackage.FSM_EVENT__SOLLICITING_TRANSITIONS:
