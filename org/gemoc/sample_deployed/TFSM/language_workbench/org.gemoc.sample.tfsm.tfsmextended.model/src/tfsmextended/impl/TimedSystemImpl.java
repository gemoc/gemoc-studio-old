 ...
 * <ul>
 *   <li>{@link tfsmextended.impl.TimedSystemImpl#getTfsms <em>Tfsms</em>}</li>
 *   <li>{@link tfsmextended.impl.TimedSystemImpl#getGlobalClocks <em>Global Clocks</em>}</li>
 *   <li>{@link tfsmextended.impl.TimedSystemImpl#getGlobalEvents <em>Global Events</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimedSystemImpl extends NamedElementImpl implements TimedSystem {
	...
	public EList<TFSM> getTfsms() {
		if (tfsms == null) {
			tfsms = new EObjectContainmentEList<TFSM>(TFSM.class, this, TfsmextendedPackage.TIMED_SYSTEM__TFSMS);
		}
		return tfsms;
	}
	...
	public EList<FSMClock> getGlobalClocks() {
		if (globalClocks == null) {
			globalClocks = new EObjectContainmentEList<FSMClock>(FSMClock.class, this, TfsmextendedPackage.TIMED_SYSTEM__GLOBAL_CLOCKS);
		}
		return globalClocks;
	}
	...
	public EList<FSMEvent> getGlobalEvents() {
		if (globalEvents == null) {
			globalEvents = new EObjectContainmentEList<FSMEvent>(FSMEvent.class, this, TfsmextendedPackage.TIMED_SYSTEM__GLOBAL_EVENTS);
		}
		return globalEvents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TfsmextendedPackage.TIMED_SYSTEM__TFSMS:
				return ((InternalEList<?>)getTfsms()).basicRemove(otherEnd, msgs);
			case TfsmextendedPackage.TIMED_SYSTEM__GLOBAL_CLOCKS:
				return ((InternalEList<?>)getGlobalClocks()).basicRemove(otherEnd, msgs);
			case TfsmextendedPackage.TIMED_SYSTEM__GLOBAL_EVENTS:
