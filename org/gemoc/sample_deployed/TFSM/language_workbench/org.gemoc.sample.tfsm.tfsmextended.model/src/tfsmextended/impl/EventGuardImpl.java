 ...
 * <ul>
 *   <li>{@link tfsmextended.impl.EventGuardImpl#getTriggeringEvent <em>Triggering Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventGuardImpl extends GuardImpl implements EventGuard {
		...
		if (triggeringEvent != null && triggeringEvent.eIsProxy()) {
			...
			if (triggeringEvent != oldTriggeringEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmextendedPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
			}
		}
	...
	public void setTriggeringEvent(FSMEvent newTriggeringEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmextendedPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmextendedPackage.EVENT_GUARD__TRIGGERING_EVENT:
