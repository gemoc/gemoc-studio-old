 ...
 * <ul>
 *   <li>{@link sigpmlextended.impl.HWPlatformImpl#getOwnedHWResources <em>Owned HW Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HWPlatformImpl extends NamedElementImpl implements HWPlatform {
	...
	protected EClass eStaticClass() {
		return SigpmlextendedPackage.Literals.HW_PLATFORM;
	}
	...
	public EList<HWRessource> getOwnedHWResources() {
		if (ownedHWResources == null) {
			ownedHWResources = new EObjectContainmentWithInverseEList<HWRessource>(HWRessource.class, this, SigpmlextendedPackage.HW_PLATFORM__OWNED_HW_RESOURCES, SigpmlextendedPackage.HW_RESSOURCE__OWNER);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SigpmlextendedPackage.HW_PLATFORM__OWNED_HW_RESOURCES:
