 ...
 * @generated
 */
public class SystemImpl extends NamedElementImpl implements sigpmlextended.System {
	/**
	...
	public NotificationChain basicSetOwnedApplication(Application newOwnedApplication, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.SYSTEM__OWNED_APPLICATION, oldOwnedApplication, newOwnedApplication);
	...
	public void setOwnedApplication(Application newOwnedApplication) {
		if (newOwnedApplication != ownedApplication) {
			...
			if (ownedApplication != null)
				msgs = ((InternalEObject)ownedApplication).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SigpmlextendedPackage.SYSTEM__OWNED_APPLICATION, null, msgs);
			if (newOwnedApplication != null)
				msgs = ((InternalEObject)newOwnedApplication).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SigpmlextendedPackage.SYSTEM__OWNED_APPLICATION, null, msgs);
			msgs = basicSetOwnedApplication(newOwnedApplication, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.SYSTEM__OWNED_APPLICATION, newOwnedApplication, newOwnedApplication));
	}
	...
	public NotificationChain basicSetOwnedHWPlatform(HWPlatform newOwnedHWPlatform, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.SYSTEM__OWNED_HW_PLATFORM, oldOwnedHWPlatform, newOwnedHWPlatform);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOwnedHWPlatform(HWPlatform newOwnedHWPlatform) {
		if (newOwnedHWPlatform != ownedHWPlatform) {
			...
			if (ownedHWPlatform != null)
				msgs = ((InternalEObject)ownedHWPlatform).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SigpmlextendedPackage.SYSTEM__OWNED_HW_PLATFORM, null, msgs);
			if (newOwnedHWPlatform != null)
				msgs = ((InternalEObject)newOwnedHWPlatform).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SigpmlextendedPackage.SYSTEM__OWNED_HW_PLATFORM, null, msgs);
			msgs = basicSetOwnedHWPlatform(newOwnedHWPlatform, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.SYSTEM__OWNED_HW_PLATFORM, newOwnedHWPlatform, newOwnedHWPlatform));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SigpmlextendedPackage.SYSTEM__OWNED_APPLICATION:
