 ...
 * <ul>
 *   <li>{@link sigpmlextended.impl.HWComputationalResourceImpl#isIsUnderPreemptiveManagement <em>Is Under Preemptive Management</em>}</li>
 *   <li>{@link sigpmlextended.impl.HWComputationalResourceImpl#getAllocatedAgents <em>Allocated Agents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HWComputationalResourceImpl extends HWRessourceImpl implements HWComputationalResource {
	...
	public void setIsUnderPreemptiveManagement(boolean newIsUnderPreemptiveManagement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.HW_COMPUTATIONAL_RESOURCE__IS_UNDER_PREEMPTIVE_MANAGEMENT, oldIsUnderPreemptiveManagement, isUnderPreemptiveManagement));
	}
	...
	public EList<Agent> getAllocatedAgents() {
		if (allocatedAgents == null) {
			allocatedAgents = new EObjectResolvingEList<Agent>(Agent.class, this, SigpmlextendedPackage.HW_COMPUTATIONAL_RESOURCE__ALLOCATED_AGENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SigpmlextendedPackage.HW_COMPUTATIONAL_RESOURCE__IS_UNDER_PREEMPTIVE_MANAGEMENT:
				return isIsUnderPreemptiveManagement();
			case SigpmlextendedPackage.HW_COMPUTATIONAL_RESOURCE__ALLOCATED_AGENTS:
