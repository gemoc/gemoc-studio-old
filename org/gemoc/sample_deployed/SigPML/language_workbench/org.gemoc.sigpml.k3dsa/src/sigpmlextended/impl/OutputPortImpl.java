 ...
 * <ul>
 *   <li>{@link sigpmlextended.impl.OutputPortImpl#getSizeWritten <em>Size Written</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutputPortImpl extends org.gemoc.sigpml.impl.OutputPortImpl implements OutputPort {
	/**
	...
	protected EClass eStaticClass() {
		return SigpmlextendedPackage.Literals.OUTPUT_PORT;
	}
	...
	public void setSizeWritten(int newSizeWritten) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlextendedPackage.OUTPUT_PORT__SIZE_WRITTEN, oldSizeWritten, sizeWritten));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SigpmlextendedPackage.OUTPUT_PORT__SIZE_WRITTEN:
