...
import fr.obeo.dsl.workflow.UpdateType;
...
public class WorkflowPackageImpl extends EPackageImpl implements WorkflowPackage {
	 ...
	 * @see fr.obeo.dsl.workflow.WorkflowPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getWorkflow_Categories() {
	 ...
	 * @generated
	 */
	public EReference getCommand_Artifacts() {
	...
	public void createPackageContents() {
		...
		createEReference(workflowEClass, WORKFLOW__CATEGORIES);
		...
		createEReference(commandEClass, COMMAND__ARTIFACTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkflow_Categories(), this.getCategory(), null, "categories", null, 0, -1, Workflow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(categoryEClass, Category.class, "Category", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCategory_Steps(), this.getStep(), null, "steps", null, 0, -1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStep_Commands(), this.getCommand(), null, "commands", null, 0, -1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCommand_Artifacts(), this.getArtifact(), null, "artifacts", null, 0, -1, Command.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArtifact_Type(), this.getUpdateType(), "type", null, 0, 1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(updateTypeEEnum, UpdateType.ADD);
		addEEnumLiteral(updateTypeEEnum, UpdateType.UPDATE);
