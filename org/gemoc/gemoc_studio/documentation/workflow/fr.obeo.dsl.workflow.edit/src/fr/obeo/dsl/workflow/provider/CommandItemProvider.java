...
import fr.obeo.dsl.workflow.Command;
...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.workflow.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.COMMAND__ARTIFACTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Command.class)) {
			case WorkflowPackage.COMMAND__DESCRIPTION:
				...
				return;
			case WorkflowPackage.COMMAND__ARTIFACTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.COMMAND__ARTIFACTS,
				 WorkflowFactory.eINSTANCE.createArtifact()));
	}
