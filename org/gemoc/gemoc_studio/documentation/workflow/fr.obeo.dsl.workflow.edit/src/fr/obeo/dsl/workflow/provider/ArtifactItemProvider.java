...
import fr.obeo.dsl.workflow.Artifact;
...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.workflow.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.ARTIFACT__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artifact_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artifact_type_feature", "_UI_Artifact_type"),
				 WorkflowPackage.Literals.ARTIFACT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Artifact.class)) {
			case WorkflowPackage.ARTIFACT__DESCRIPTION:
			case WorkflowPackage.ARTIFACT__TYPE:
