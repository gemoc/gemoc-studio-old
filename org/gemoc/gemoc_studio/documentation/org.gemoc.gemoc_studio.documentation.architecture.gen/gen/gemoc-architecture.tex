...
%Start of user code Domain Specific MetamodelDescription
%End of user code 
\end{itemize}
...
%Start of user code Xtext GrammarDescription
%End of user code 
\end{itemize}
...
%Start of user code Domain Text EditorDescription
%End of user code 
\end{itemize}
...
%Start of user code MOCC ModelDescription
%End of user code 
  \item \textbf{Kermeta Model} :
%Start of user code Kermeta ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code ECL ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code CCSL ModelDescription
%End of user code 
  \item \textbf{Trigger Event Request} :
%Start of user code Trigger Event RequestDescription
%End of user code 
\end{itemize}
...
%Start of user code Domain Specific Event Vector ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Trace ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Gemoc Project State ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Domain Specific ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Execution ModelDescription
%End of user code 
  \item \textbf{Domain Specific Metamodel Byte Code} :
%Start of user code Domain Specific Metamodel Byte CodeDescription
%End of user code 
  \item \textbf{Domain Specific Event Model} :
%Start of user code Domain Specific Event ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Runtime ControllerDescription
%End of user code 
\end{itemize}
...
%Start of user code Launch UtilitiesDescription
%End of user code 
  \item \textbf{Debug User Interface} :
%Start of user code Debug User InterfaceDescription
%End of user code 
\end{itemize}
...
%Start of user code Domain Specific  Representation Definition ModelDescription
%End of user code 
  \item \textbf{Domain Specific Metamodel} :
%Start of user code Domain Specific MetamodelDescription
%End of user code 
...
%Start of user code Domain Specific Representation Definition Extension ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Concurrency Execution ModelDescription
%End of user code 
  \item \textbf{Domain Specific Event Model} :
%Start of user code Domain Specific Event ModelDescription
%End of user code 
...
%Start of user code DSA ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code Modeling ProjectDescription
%End of user code 
\end{itemize}
...
%Start of user code DSE ModelDescription
%End of user code 
\end{itemize}
...
%Start of user code ECL Model

%End of user code

\subsection{MOCC Model}
%Start of user code MOCC Model

%End of user code

\subsection{DSA Model}
%Start of user code DSA Model

%End of user code

\subsection{Execution Model}
%Start of user code Execution Model

%End of user code

\subsection{Trace Model}
%Start of user code Trace Model

%End of user code

\subsection{Domain Specific  Representation Definition Model}
%Start of user code Domain Specific  Representation Definition Model

%End of user code

\subsection{Ecore Model}
%Start of user code Ecore Model

%End of user code

\subsection{Domain Specific Model}
%Start of user code Domain Specific Model

%End of user code

\subsection{Domain Specific Event Vector Model}
%Start of user code Domain Specific Event Vector Model

%End of user code

\subsection{Concurrency Execution Model}
%Start of user code Concurrency Execution Model

%End of user code

\subsection{Gemoc Project State Model}
%Start of user code Gemoc Project State Model

%End of user code

\subsection{CCSL Model}
%Start of user code CCSL Model

%End of user code

\subsection{Domain Specific Metamodel}
%Start of user code Domain Specific Metamodel

%End of user code

\subsection{Scenario Model}
%Start of user code Scenario Model

%End of user code

\subsection{DSE Model}
%Start of user code DSE Model

%End of user code

\subsection{Domain Specific Representation Definition Extension Model}
%Start of user code Domain Specific Representation Definition Extension Model

%End of user code

\subsection{Domain Specific Event Model}
%Start of user code Domain Specific Event Model

%End of user code

\subsection{Kermeta Model}
%Start of user code Kermeta Model
