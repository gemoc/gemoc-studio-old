...
\begin{itemize}
	...
	\item User component artefacts are the result of some of the Gemoc components and are specific to the user use case. They are used in the main process as input of other component or as a tool to produce other artefact. As they are specific to the user, these artifact are prefixed with Ã¢â‚¬Å“UserÃ¢â‚¬ï¿½
\end{itemize}
...
%	\label{fig:EMF Tree Editor Generator}
	\end{center}
\end{figure}
...
%	\label{fig:Timesquare DSA-MOCC Map Editor}
	\end{center}
\end{figure}
...
%	\label{fig:User Animation Viewer}
	\end{center}
\end{figure}
...
%	\label{fig:Gemoc Process assistant}
	\end{center}
\end{figure}
...
%End of user code 
\begin{center}
\includegraphics*[trim=0.0cm 0.0cm 0cm 0.0cm, clip=true]{../images/generated/Generated_Modhel'X.png}
\end{center}
...
%	\label{fig:Timesquare MOCC To Execution Model}
	\end{center}
\end{figure}
...
\item The ability to integrate and deploy the aforementioned environment into Eclipse IDEÃ¢â‚¬â„¢s or RCP applications.
...
%	\label{fig:Sirius Animator Framework}
	\end{center}
\end{figure}
...
\textbf{\textcolor{red}{FBO: pas sur de bien comprendre ce qu'est le DSEVM ou bien ce qu'il fait lÃƒÂ  . J'aurais plutÃƒÂ´t dit que Policy avait besoin du Domain Specific Event Model}}
%End of user code 
\end{itemize}
...
%	\label{fig:Executable Modeling Tools}
	\end{center}
\end{figure}
...
%	\label{fig:Execution Engine for Heterogeneous Models}
	\end{center}
\end{figure}
...
%	\label{fig:Language Definition Tools}
	\end{center}
\end{figure}
...
%	\label{fig:Reflexive Model Animators}
	\end{center}
\end{figure}
...
%	\label{fig:Language Composition tools}
	\end{center}
\end{figure}
...
%	\label{fig:Composition Operator Editor}
	\end{center}
\end{figure}
...
%	\label{fig:Composition Operator Applicator}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Tree Editor}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Graphical Animated Editor}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Graphical Animator}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Text Editor}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Metamodel Byte Code}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Metamodel Byte Code Extension}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific Editor}
	\end{center}
\end{figure}
...
%	\label{fig:Domain Specific MOCC To Execution Model}
	\end{center}
\end{figure}
