...
\textbf{\textcolor{red}{FBO: pas sur de bien comprendre ce qu'est le DSEVM ou bien ce qu'il fait là. J'aurais plut\^ot dit que Policy avait besoin du Domain Specific Event Model}}
%End of user code 
\end{itemize}
