...
\textcolor{red}{\textbf{FBO: A mon avis, il manque le mod\`ele du scenario en input.}}
%End of user code
...
\textbf{\textcolor{red}{FBO: pas sur de bien comprendre ce qu'est le DSEVM ou bien ce qu'il fait lÃ . J'aurais plut\^ot dit que Policy avait besoin du Domain Specific Event Model}}
%End of user code 
\end{itemize}
