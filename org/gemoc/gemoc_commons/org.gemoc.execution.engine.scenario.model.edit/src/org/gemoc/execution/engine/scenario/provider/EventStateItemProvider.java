...
/**
 * This is the item provider adapter for a {@link org.gemoc.execution.engine.scenario.EventState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventStateItemProvider 
	 ...
	 * @generated
	 */
	public EventStateItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addClockPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventState_clock_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventState_clock_feature", "_UI_EventState_type"),
				 ScenarioPackage.Literals.EVENT_STATE__CLOCK,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventState"));
	}
