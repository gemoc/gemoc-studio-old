 ...
 * @generated
 */
public class GmmlSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static GmmlPackage modelPackage;
	...
	public GmmlSwitch() {
		if (modelPackage == null) {
			modelPackage = GmmlPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GmmlPackage.MODEL_SPECIFIC_EVENT_FILE: {
				ModelSpecificEventFile modelSpecificEventFile = (ModelSpecificEventFile)theEObject;
				T result = caseModelSpecificEventFile(modelSpecificEventFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GmmlPackage.MODEL_SPECIFIC_EVENT: {
			...
			case GmmlPackage.IMPORT_STATEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Model Specific Event File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Model Specific Event File</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModelSpecificEventFile(ModelSpecificEventFile object) {
		return null;
	}
