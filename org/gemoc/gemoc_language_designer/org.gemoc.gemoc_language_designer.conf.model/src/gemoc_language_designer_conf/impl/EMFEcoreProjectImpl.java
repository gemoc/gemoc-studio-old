 ...
 * <ul>
 *   <li>{@link gemoc_language_designer_conf.impl.EMFEcoreProjectImpl#getEcoreModel <em>Ecore Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EMFEcoreProjectImpl extends DomainModelProjectImpl implements EMFEcoreProject {
	...
	protected EClass eStaticClass() {
		return Gemoc_language_designer_confPackage.Literals.EMF_ECORE_PROJECT;
	}
	...
	public NotificationChain basicSetEcoreModel(EcoreModel newEcoreModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gemoc_language_designer_confPackage.EMF_ECORE_PROJECT__ECORE_MODEL, oldEcoreModel, newEcoreModel);
	...
	public void setEcoreModel(EcoreModel newEcoreModel) {
		if (newEcoreModel != ecoreModel) {
			...
			if (ecoreModel != null)
				msgs = ((InternalEObject)ecoreModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gemoc_language_designer_confPackage.EMF_ECORE_PROJECT__ECORE_MODEL, null, msgs);
			if (newEcoreModel != null)
				msgs = ((InternalEObject)newEcoreModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gemoc_language_designer_confPackage.EMF_ECORE_PROJECT__ECORE_MODEL, null, msgs);
			msgs = basicSetEcoreModel(newEcoreModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gemoc_language_designer_confPackage.EMF_ECORE_PROJECT__ECORE_MODEL, newEcoreModel, newEcoreModel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Gemoc_language_designer_confPackage.EMF_ECORE_PROJECT__ECORE_MODEL:
