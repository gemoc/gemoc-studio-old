...
public class LanguageFinder {
	...
	static public IConfigurationElement findDefinition(String languageName)
	{
		...
		IConfigurationElement[] confElements = Platform.getExtensionRegistry().getConfigurationElementsFor(LanguageDefinitionExtension.GEMOC_LANGUAGE_EXTENSION_POINT_NAME);
