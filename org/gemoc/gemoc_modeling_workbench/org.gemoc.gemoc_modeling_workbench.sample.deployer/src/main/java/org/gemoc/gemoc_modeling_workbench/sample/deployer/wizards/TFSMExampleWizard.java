...
public class TFSMExampleWizard
	...
	protected Collection<ProjectDescriptor> getProjectDescriptors() {		
		...
		projects.add(new ProjectDescriptor(Activator.PLUGIN_ID, "zips/org.gemoc.sample.tfsm.traffic_light_example_model.zip", "org.gemoc.sample.tfsm.traffic_light_example_model"));
		return projects;
	}
