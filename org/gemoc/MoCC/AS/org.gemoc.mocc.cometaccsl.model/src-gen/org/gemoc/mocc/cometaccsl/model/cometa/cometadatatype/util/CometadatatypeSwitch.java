 ...
 * @generated
 */
public class CometadatatypeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CometadatatypePackage.TYPE_DECLARATION: {
			...
			case CometadatatypePackage.DATA_TYPE_LIBRARY: {
