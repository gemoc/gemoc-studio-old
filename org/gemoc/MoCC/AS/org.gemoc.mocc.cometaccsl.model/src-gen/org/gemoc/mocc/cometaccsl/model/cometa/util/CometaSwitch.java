 ...
 * $Id$
 */
package org.gemoc.mocc.cometaccsl.model.cometa.util;
 ...
 * <!-- end-user-doc -->
 * @see org.gemoc.mocc.cometaccsl.model.cometa.CometaPackage
 * @generated
 */
public class CometaSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static CometaPackage modelPackage;
	...
	public CometaSwitch() {
		if (modelPackage == null) {
			modelPackage = CometaPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CometaPackage.MO_CSYSTEM_SPECIFICATION: {
				MoCSystemSpecification moCSystemSpecification = (MoCSystemSpecification)theEObject;
				T result = caseMoCSystemSpecification(moCSystemSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometaPackage.COMETA_SYSTEM_SPECIFICATION: {
				CometaSystemSpecification cometaSystemSpecification = (CometaSystemSpecification)theEObject;
				T result = caseCometaSystemSpecification(cometaSystemSpecification);
				if (result == null) result = caseMoCSystemSpecification(cometaSystemSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometaPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometaPackage.ELEMENT_ABSTRACTION: {
				ElementAbstraction elementAbstraction = (ElementAbstraction)theEObject;
				T result = caseElementAbstraction(elementAbstraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometaPackage.MO_CLIBRARY: {
				MoCLibrary moCLibrary = (MoCLibrary)theEObject;
				T result = caseMoCLibrary(moCLibrary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
