...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometafsm.model.cometafsm.CometaElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CometaElementItemProvider
	 ...
	 * @generated
	 */
	public CometaElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CometaElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CometaElement_type") :
			getString("_UI_CometaElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CometaElement.class)) {
