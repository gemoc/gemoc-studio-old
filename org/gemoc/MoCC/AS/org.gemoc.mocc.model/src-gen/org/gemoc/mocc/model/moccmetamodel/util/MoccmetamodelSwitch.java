 ...
 * @generated
 */
public class MoccmetamodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MoccmetamodelPackage.STATE_MACHINE_RELATION_DEFINITION: {
			...
			case MoccmetamodelPackage.STATE: {
			...
			case MoccmetamodelPackage.TRANSITION: {
			...
			case MoccmetamodelPackage.STATE_BASE_RELATION_LIBRARY: {
				StateBaseRelationLibrary stateBaseRelationLibrary = (StateBaseRelationLibrary)theEObject;
				T result = caseStateBaseRelationLibrary(stateBaseRelationLibrary);
				if (result == null) result = caseLibrary(stateBaseRelationLibrary);
				if (result == null) result = caseNamedElement(stateBaseRelationLibrary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoccmetamodelPackage.INTEGER_ASSIGNMENT: {
				...
				if (result == null) result = caseElement(integerAssignment);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Base Relation Library</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Base Relation Library</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateBaseRelationLibrary(StateBaseRelationLibrary object) {
		return null;
	}
