...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometatime.Ack} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AckItemProvider
	 ...
	 * @generated
	 */
	public AckItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_kind_feature", "_UI_Interface_type"),
				 CometatimePackage.Literals.INTERFACE__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_uses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_uses_feature", "_UI_Event_type"),
				 CometatimePackage.Literals.EVENT__USES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometatimePackage.Literals.EVENT__EVENT_PARAMETERS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Ack"));
	}
	...
	public String getText(Object object) {
		String label = ((Ack)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Ack_type") :
			getString("_UI_Ack_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ack.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometatimePackage.Literals.EVENT__EVENT_PARAMETERS,
