...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometastructure.StructureLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructureLibraryItemProvider
	 ...
	 * @generated
	 */
	public StructureLibraryItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_STRUCTURES);
			childrenFeatures.add(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_INTERFACES);
		}
	...
	/**
	 * This returns StructureLibrary.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StructureLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((StructureLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StructureLibrary_type") :
			getString("_UI_StructureLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StructureLibrary.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_STRUCTURES,
				 CometastructureFactory.eINSTANCE.createStructureContainer()));

		newChildDescriptors.add
			(createChildParameter
				(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_INTERFACES,
				 CometatimeFactory.eINSTANCE.createSend()));

		newChildDescriptors.add
			(createChildParameter
				(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_INTERFACES,
				 CometatimeFactory.eINSTANCE.createReceive()));

		newChildDescriptors.add
			(createChildParameter
				(CometastructurePackage.Literals.STRUCTURE_LIBRARY__MOC_INTERFACES,
				 CometatimeFactory.eINSTANCE.createAck()));
	}
