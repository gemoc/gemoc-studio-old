...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.MoCEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoCEventItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MoCEvent"));
	}
	...
	public String getText(Object object) {
		String label = ((MoCEvent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MoCEvent_type") :
			getString("_UI_MoCEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MoCEvent.class)) {
