...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.Queue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Queue_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Queue_kind_feature", "_UI_Queue_type"),
				 CometamocPackage.Literals.QUEUE__KIND,
				 true,
				 false,
				 false,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Queue_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Queue_size_feature", "_UI_Queue_type"),
				 CometamocPackage.Literals.QUEUE__SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometamocPackage.Literals.QUEUE__RT_INTERFACES);
		}
	...
	public String getText(Object object) {
		QueueKind labelValue = ((Queue)object).getKind();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.QUEUE__RT_INTERFACES,
