...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometatime.TimeLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeLibraryItemProvider
	 ...
	 * @generated
	 */
	public TimeLibraryItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometatimePackage.Literals.TIME_LIBRARY__CLOCKS);
			childrenFeatures.add(CometatimePackage.Literals.TIME_LIBRARY__GLOBAL_TIME_CONSTRAINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TimeLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((TimeLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TimeLibrary_type") :
			getString("_UI_TimeLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TimeLibrary.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometatimePackage.Literals.TIME_LIBRARY__CLOCKS,
				 Ccsl4cometaspecialisationFactory.eINSTANCE.createCCSL4CometaClock()));

		newChildDescriptors.add
			(createChildParameter
				(CometatimePackage.Literals.TIME_LIBRARY__GLOBAL_TIME_CONSTRAINTS,
