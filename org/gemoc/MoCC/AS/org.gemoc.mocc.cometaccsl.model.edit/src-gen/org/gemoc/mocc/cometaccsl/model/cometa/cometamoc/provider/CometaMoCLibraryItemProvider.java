...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.CometaMoCLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CometaMoCLibraryItemProvider
	 ...
	 * @generated
	 */
	public CometaMoCLibraryItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometamocPackage.Literals.COMETA_MO_CLIBRARY__MOC_DOMAINS);
			childrenFeatures.add(CometamocPackage.Literals.COMETA_MO_CLIBRARY__MOC_EVENTS);
			childrenFeatures.add(CometamocPackage.Literals.COMETA_MO_CLIBRARY__QUEUES);
		}
	...
	/**
	 * This returns CometaMoCLibrary.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CometaMoCLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((CometaMoCLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CometaMoCLibrary_type") :
			getString("_UI_CometaMoCLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CometaMoCLibrary.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.COMETA_MO_CLIBRARY__MOC_DOMAINS,
				 CometamocFactory.eINSTANCE.createMoCDomain()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.COMETA_MO_CLIBRARY__MOC_EVENTS,
				 CometamocFactory.eINSTANCE.createMoCEvent()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.COMETA_MO_CLIBRARY__QUEUES,
				 CometamocFactory.eINSTANCE.createQueue()));
	}
