...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.QueueInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueueInstanceItemProvider
	 ...
	 * @generated
	 */
	public QueueInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QueueInstance_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QueueInstance_type_feature", "_UI_QueueInstance_type"),
				 CometamocPackage.Literals.QUEUE_INSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns QueueInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/QueueInstance"));
	}
	...
	public String getText(Object object) {
		String label = ((QueueInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QueueInstance_type") :
			getString("_UI_QueueInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QueueInstance.class)) {
