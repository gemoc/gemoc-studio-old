...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometastructure.MoCConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoCConnectorItemProvider
	 ...
	 * @generated
	 */
	public MoCConnectorItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MoCConnector_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MoCConnector_source_feature", "_UI_MoCConnector_type"),
				 CometastructurePackage.Literals.MO_CCONNECTOR__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MoCConnector_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MoCConnector_target_feature", "_UI_MoCConnector_type"),
				 CometastructurePackage.Literals.MO_CCONNECTOR__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MoCConnector_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MoCConnector_kind_feature", "_UI_MoCConnector_type"),
				 CometastructurePackage.Literals.MO_CCONNECTOR__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MoCConnector"));
	}
	...
	public String getText(Object object) {
		String label = ((MoCConnector)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MoCConnector_type") :
			getString("_UI_MoCConnector_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MoCConnector.class)) {
