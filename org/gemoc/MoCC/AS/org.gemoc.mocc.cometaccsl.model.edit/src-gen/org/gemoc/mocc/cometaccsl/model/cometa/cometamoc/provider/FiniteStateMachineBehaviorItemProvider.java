...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.FiniteStateMachineBehavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FiniteStateMachineBehaviorItemProvider
	 ...
	 * @generated
	 */
	public FiniteStateMachineBehaviorItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_roles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_roles_feature", "_UI_Behavior_type"),
				 CometamocPackage.Literals.BEHAVIOR__ROLES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometamocPackage.Literals.BEHAVIOR__QUEUE_INSTANCES);
			childrenFeatures.add(CometamocPackage.Literals.BEHAVIOR__RT_INTERFACES);
			childrenFeatures.add(CometamocPackage.Literals.BEHAVIOR__BEHAVIOR_TIME_CONSTRAINTS);
	...
	/**
	 * This returns FiniteStateMachineBehavior.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FiniteStateMachineBehavior"));
	}
	...
	public String getText(Object object) {
		String label = ((FiniteStateMachineBehavior)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FiniteStateMachineBehavior_type") :
			getString("_UI_FiniteStateMachineBehavior_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FiniteStateMachineBehavior.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.BEHAVIOR__QUEUE_INSTANCES,
				 CometamocFactory.eINSTANCE.createQueueInstance()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.BEHAVIOR__RT_INTERFACES,
				 CometatimeFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.BEHAVIOR__RT_INTERFACES,
				 CometatimeFactory.eINSTANCE.createService()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.BEHAVIOR__BEHAVIOR_TIME_CONSTRAINTS,
				 Ccsl4cometaspecialisationFactory.eINSTANCE.createCCSL4CometaTimeConstraint()));
