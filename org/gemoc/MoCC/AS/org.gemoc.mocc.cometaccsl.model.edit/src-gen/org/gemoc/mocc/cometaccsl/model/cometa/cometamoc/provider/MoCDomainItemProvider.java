...
/**
 * This is the item provider adapter for a {@link org.gemoc.mocc.cometaccsl.model.cometa.cometamoc.MoCDomain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoCDomainItemProvider
	 ...
	 * @generated
	 */
	public MoCDomainItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CometamocPackage.Literals.MO_CDOMAIN__MOC_BEHAVIORS);
			childrenFeatures.add(CometamocPackage.Literals.MO_CDOMAIN__DOMAIN_TIME_CONSTRAINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MoCDomain"));
	}
	...
	public String getText(Object object) {
		String label = ((MoCDomain)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MoCDomain_type") :
			getString("_UI_MoCDomain_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MoCDomain.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.MO_CDOMAIN__MOC_BEHAVIORS,
				 CometamocFactory.eINSTANCE.createOpaqueBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.MO_CDOMAIN__MOC_BEHAVIORS,
				 CometamocFactory.eINSTANCE.createFiniteStateMachineBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(CometamocPackage.Literals.MO_CDOMAIN__DOMAIN_TIME_CONSTRAINTS,
