 ...
 * <ul>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.StateImpl#getInputTransitions <em>Input Transitions</em>}</li>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.StateImpl#getOutputTransitions <em>Output Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StateImpl extends CometaElementImpl implements State {
	/**
	...
	protected EClass eStaticClass() {
		return CometafsmPackage.Literals.STATE;
	}
	...
	public EList<Transition> getInputTransitions() {
		if (inputTransitions == null) {
			inputTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, CometafsmPackage.STATE__INPUT_TRANSITIONS, CometafsmPackage.TRANSITION__TARGET);
		}
	...
	public EList<Transition> getOutputTransitions() {
		if (outputTransitions == null) {
			outputTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, CometafsmPackage.STATE__OUTPUT_TRANSITIONS, CometafsmPackage.TRANSITION__SOURCE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CometafsmPackage.STATE__INPUT_TRANSITIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInputTransitions()).basicAdd(otherEnd, msgs);
			case CometafsmPackage.STATE__OUTPUT_TRANSITIONS:
