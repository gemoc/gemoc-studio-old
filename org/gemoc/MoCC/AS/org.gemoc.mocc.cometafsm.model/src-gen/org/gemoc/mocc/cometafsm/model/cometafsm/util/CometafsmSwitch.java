 ...
 * @generated
 */
public class CometafsmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CometafsmPackage.COMETA_ELEMENT: {
				CometaElement cometaElement = (CometaElement)theEObject;
				T result = caseCometaElement(cometaElement);
				if (result == null) result = caseNamedElement(cometaElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometafsmPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = caseCometaElement(state);
				if (result == null) result = caseNamedElement(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometafsmPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = caseCometaElement(transition);
				if (result == null) result = caseNamedElement(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CometafsmPackage.STATE_MACHINE_DEFINITION: {
			...
			case CometafsmPackage.INTEGER_ASSIGNEMENT: {
			...
			case CometafsmPackage.DECLARATION_BLOCK: {
