 ...
 * <ul>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.DeclarationBlockImpl#getConcreteEntities <em>Concrete Entities</em>}</li>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.DeclarationBlockImpl#getClassicalExpressions <em>Classical Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclarationBlockImpl extends MinimalEObjectImpl.Container implements DeclarationBlock {
	...
	protected EClass eStaticClass() {
		return CometafsmPackage.Literals.DECLARATION_BLOCK;
	}
	...
	public EList<ConcreteEntity> getConcreteEntities() {
		if (concreteEntities == null) {
			concreteEntities = new EObjectContainmentEList<ConcreteEntity>(ConcreteEntity.class, this, CometafsmPackage.DECLARATION_BLOCK__CONCRETE_ENTITIES);
		}
	...
	public EList<ClassicalExpression> getClassicalExpressions() {
		if (classicalExpressions == null) {
			classicalExpressions = new EObjectContainmentEList<ClassicalExpression>(ClassicalExpression.class, this, CometafsmPackage.DECLARATION_BLOCK__CLASSICAL_EXPRESSIONS);
		}
