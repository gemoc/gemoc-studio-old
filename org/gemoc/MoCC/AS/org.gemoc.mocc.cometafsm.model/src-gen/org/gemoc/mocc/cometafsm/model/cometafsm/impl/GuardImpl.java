 ...
 * <ul>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.GuardImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GuardImpl extends AbstractGuardImpl implements Guard {
	...
	protected EClass eStaticClass() {
		return CometafsmPackage.Literals.GUARD;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CometafsmPackage.GUARD__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(BooleanExpression newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CometafsmPackage.GUARD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CometafsmPackage.GUARD__VALUE:
