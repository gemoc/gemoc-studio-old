 ...
 * <ul>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.TriggerImpl#getTrueTriggers <em>True Triggers</em>}</li>
 *   <li>{@link org.gemoc.mocc.cometafsm.model.cometafsm.impl.TriggerImpl#getFalseTriggers <em>False Triggers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TriggerImpl extends AbstractTriggerImpl implements Trigger {
	...
	protected EClass eStaticClass() {
		return CometafsmPackage.Literals.TRIGGER;
	}
	...
	public EList<BindableEntity> getTrueTriggers() {
		if (trueTriggers == null) {
			trueTriggers = new EObjectResolvingEList<BindableEntity>(BindableEntity.class, this, CometafsmPackage.TRIGGER__TRUE_TRIGGERS);
		}
		return trueTriggers;
	}
	...
	public EList<BindableEntity> getFalseTriggers() {
		if (falseTriggers == null) {
			falseTriggers = new EObjectResolvingEList<BindableEntity>(BindableEntity.class, this, CometafsmPackage.TRIGGER__FALSE_TRIGGERS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CometafsmPackage.TRIGGER__TRUE_TRIGGERS:
				return getTrueTriggers();
			case CometafsmPackage.TRIGGER__FALSE_TRIGGERS:
