 ...
 * generated by Xtext
 */
package org.gemoc.mocc.cometafsm.model.xtext.formatting;
...
public class FSMDslFormatter extends AbstractDeclarativeFormatter {
  ...
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._fSMDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._fSMDslGrammarAccess.findKeywords(",");
