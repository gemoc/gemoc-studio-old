...
public class FSMDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.gemoc.mocc.cometafsm.model.xtext.parser.antlr.internal.InternalFSMDslParser createParser(XtextTokenStream stream) {
		return new org.gemoc.mocc.cometafsm.model.xtext.parser.antlr.internal.InternalFSMDslParser(stream, getGrammarAccess());
	}
