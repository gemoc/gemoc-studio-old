 ...
 * generated by Xtext
 */
package org.gemoc.mocc.cometaccsl.model.xtext.formatting;
...
public class MoCDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private MoCDslGrammarAccess _moCDslGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._moCDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._moCDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._moCDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._moCDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._moCDslGrammarAccess.getML_COMMENTRule();
