 ...
 * <ul>
 *   <li>{@link gepl.impl.ECLEventImpl#getElement <em>Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ECLEventImpl extends MocEventImpl implements ECLEvent {
	...
	protected EClass eStaticClass() {
		return GeplPackage.Literals.ECL_EVENT;
	}
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeplPackage.ECL_EVENT__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(DefPropertyCS newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeplPackage.ECL_EVENT__ELEMENT, oldElement, element));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeplPackage.ECL_EVENT__ELEMENT:
