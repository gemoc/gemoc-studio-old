...
public class StateItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOwningTfsmPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Owning Tfsm feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOwningTfsmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_owningTfsm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_owningTfsm_feature", "_UI_State_type"),
				 TfsmPackage.Literals.STATE__OWNING_TFSM,
				 true,
				 false,
				 true,
				 null,
