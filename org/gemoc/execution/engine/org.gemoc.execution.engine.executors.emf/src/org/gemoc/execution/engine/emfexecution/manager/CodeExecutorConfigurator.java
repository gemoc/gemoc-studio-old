...
public class CodeExecutorConfigurator extends BehaviorConfigurator<EmfCodeExecutionManager> {

    public CodeExecutorConfigurator(ConfigurationHelper _ch, EmfCodeExecutionManager _behaviorManager) {
    ...
    public HashMap<String, Object> getData() {
        return this.getBehaviorManager().getData();
    }
}
