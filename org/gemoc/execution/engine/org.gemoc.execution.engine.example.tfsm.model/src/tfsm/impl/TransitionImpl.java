 ...
 * <li>{@link tfsm.impl.TransitionImpl#getGeneratedEvents <em>Generated Events
 * </em>}</li>
...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	/**
	 * The cached value of the '{@link #getOwnedGuard() <em>Owned Guard</em>}'
	...
	/**
	 * The cached value of the '{@link #getGeneratedEvents()
	 * <em>Generated Events</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmPackage.TRANSITION__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public State getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmPackage.TRANSITION__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public NotificationChain basicSetOwnedGuard(Guard newOwnedGuard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TfsmPackage.TRANSITION__OWNED_GUARD, oldOwnedGuard, newOwnedGuard);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwnedGuard(Guard newOwnedGuard) {
		if (newOwnedGuard != ownedGuard) {
			...
			if (ownedGuard != null)
				msgs = ((InternalEObject) ownedGuard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- TfsmPackage.TRANSITION__OWNED_GUARD, null, msgs);
			if (newOwnedGuard != null)
				msgs = ((InternalEObject) newOwnedGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- TfsmPackage.TRANSITION__OWNED_GUARD, null, msgs);
			msgs = basicSetOwnedGuard(newOwnedGuard, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__OWNED_GUARD, newOwnedGuard,
					newOwnedGuard));
	}
	...
	public EList<TfsmEvent> getGeneratedEvents() {
		if (generatedEvents == null) {
			generatedEvents = new EObjectResolvingEList<TfsmEvent>(TfsmEvent.class, this,
					TfsmPackage.TRANSITION__GENERATED_EVENTS);
		}
	 ...
	 */
	public String fire() {
		GroovyRunner.executeScript(this.action);
		this.source.getOwningTfsm().setCurrentState(this.target);
		return "[DSA Transition.fire]Fired " + this.name + " -> " + this.action;
