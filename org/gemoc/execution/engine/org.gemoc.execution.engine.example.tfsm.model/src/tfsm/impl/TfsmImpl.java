 ...
 * <li>{@link tfsm.impl.TfsmImpl#getOwnedTransitions <em>Owned Transitions</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class TfsmImpl extends NamedElementImpl implements Tfsm {
	...
	/**
	 * The cached value of the '{@link #getOwnedStates() <em>Owned States</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedEvents() <em>Owned Events</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOwnedEvents()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOwnedClock() <em>Owned Clock</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedTransitions()
	 * <em>Owned Transitions</em>}' containment reference list. <!--
		...
		if (initialState != null && initialState.eIsProxy()) {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmPackage.TFSM__INITIAL_STATE,
	...
	public void setInitialState(State newInitialState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TFSM__INITIAL_STATE, oldInitialState,
					initialState));
	}
	...
	public NotificationChain basicSetOwnedClock(TfsmClock newOwnedClock, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TfsmPackage.TFSM__OWNED_CLOCK, oldOwnedClock, newOwnedClock);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwnedClock(TfsmClock newOwnedClock) {
		if (newOwnedClock != ownedClock) {
			...
			if (ownedClock != null)
				msgs = ((InternalEObject) ownedClock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- TfsmPackage.TFSM__OWNED_CLOCK, null, msgs);
			if (newOwnedClock != null)
				msgs = ((InternalEObject) newOwnedClock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- TfsmPackage.TFSM__OWNED_CLOCK, null, msgs);
			msgs = basicSetOwnedClock(newOwnedClock, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TFSM__OWNED_CLOCK, newOwnedClock,
					newOwnedClock));
	}
	...
	public EList<Transition> getOwnedTransitions() {
		if (ownedTransitions == null) {
			ownedTransitions = new EObjectContainmentEList<Transition>(Transition.class, this,
					TfsmPackage.TFSM__OWNED_TRANSITIONS);
		}
	...
	public String initialize() {
		...
		return "[DSA Transition.Init]Initialized " + this.name;
	}
