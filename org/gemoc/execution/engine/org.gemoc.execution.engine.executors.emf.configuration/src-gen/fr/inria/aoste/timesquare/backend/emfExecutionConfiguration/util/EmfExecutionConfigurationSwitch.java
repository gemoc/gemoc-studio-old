...
public class EmfExecutionConfigurationSwitch<T> extends Switch<T> {
    ...
    public EmfExecutionConfigurationSwitch() {
        if (EmfExecutionConfigurationSwitch.modelPackage == null) {
            EmfExecutionConfigurationSwitch.modelPackage = EmfExecutionConfigurationPackage.eINSTANCE;
        }
    }
     ...
     *         <em>EMF Execution Configuration</em>'.
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Forced Clock Mapping</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     * 
     * @param object
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Import Statement</em>'. <!-- begin-user-doc --> This implementation
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Jar Import Statement</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     * 
     * @param object
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case EmfExecutionConfigurationPackage.EMF_EXECUTION_CONFIGURATION: {
                ...
                T result = this.caseEMFExecutionConfiguration(emfExecutionConfiguration);
                if (result == null) {
            ...
            case EmfExecutionConfigurationPackage.FORCED_CLOCK_MAPPING: {
                ...
                T result = this.caseForcedClockMapping(forcedClockMapping);
                if (result == null) {
                    result = this.defaultCase(theEObject);
                }
                return result;
            ...
            case EmfExecutionConfigurationPackage.IMPORT_STATEMENT: {
                ...
                T result = this.caseImportStatement(importStatement);
                if (result == null) {
                    result = this.defaultCase(theEObject);
                }
                return result;
            ...
            case EmfExecutionConfigurationPackage.JAR_IMPORT_STATEMENT: {
                ...
                T result = this.caseJarImportStatement(jarImportStatement);
                if (result == null) {
                    result = this.defaultCase(theEObject);
                }
                return result;
