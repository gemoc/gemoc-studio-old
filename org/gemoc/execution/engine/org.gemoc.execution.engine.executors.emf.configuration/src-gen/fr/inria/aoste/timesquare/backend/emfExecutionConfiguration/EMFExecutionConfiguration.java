...
public interface EMFExecutionConfiguration extends EObject {
    /**
     * Returns the value of the '<em><b>Forced Clock Mappings</b></em>'
     * containment reference list. The list contents are of type
     * {@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping}
     * . <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Forced Clock Mappings</em>' containment
     * reference list isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Forced Clock Mappings</em>' containment
     *         reference list.
    ...
    /**
     * Returns the value of the '<em><b>Jar Import Statement</b></em>'
     * containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Jar Import Statement</em>' containment
     * reference isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Jar Import Statement</em>' containment
     *         reference.
     ...
     * 
     * @param value
     *            the new value of the '<em>Jar Import Statement</em>'
