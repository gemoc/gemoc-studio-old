...
public interface ForcedClockMapping extends EObject {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Clock</em>' reference isn't clear, there
    ...
    /**
     * Returns the value of the '<em><b>Clock To Avoid When True</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Clock To Avoid When True</em>' reference isn't
     ...
     * {@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping#getClock
     * <em>Clock</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Clock</em>' reference.
     * @see #getClock()
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Clock To Avoid When True</em>'
     *            reference.
