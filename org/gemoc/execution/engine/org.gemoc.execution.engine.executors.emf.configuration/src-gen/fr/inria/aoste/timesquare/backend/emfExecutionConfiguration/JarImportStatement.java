...
public interface JarImportStatement extends EObject {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Path To Jar</em>' attribute isn't clear, there
     ...
     * {@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.JarImportStatement#getPathToJar
     * <em>Path To Jar</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Path To Jar</em>' attribute.
     * @see #getPathToJar()
     * @generated
     */
