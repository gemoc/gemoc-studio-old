/**
 */
package javasolverinput.creation.provider;
...
import javasolverinput.provider.NamedElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link javasolverinput.creation.RelationDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationDeclarationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CreationPackage.Literals.RELATION_DECLARATION__PARAMETERS);
			childrenFeatures.add(CreationPackage.Literals.RELATION_DECLARATION__DEFINITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CreationPackage.Literals.RELATION_DECLARATION__PARAMETERS,
				 CreationFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(CreationPackage.Literals.RELATION_DECLARATION__DEFINITION,
				 CreationFactory.eINSTANCE.createRelationDefinition()));
	}
