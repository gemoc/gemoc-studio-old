		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JavaSolverInputFile_clocks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JavaSolverInputFile_clocks_feature", "_UI_JavaSolverInputFile_type"),
				 JavasolverinputPackage.Literals.JAVA_SOLVER_INPUT_FILE__CLOCKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConstraintsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JavaSolverInputFile_constraints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JavaSolverInputFile_constraints_feature", "_UI_JavaSolverInputFile_type"),
