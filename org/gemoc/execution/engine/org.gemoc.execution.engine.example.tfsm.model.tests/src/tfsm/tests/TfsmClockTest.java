 ...
 * @generated
 */
public class TfsmClockTest extends NamedElementTest {
    ...
    public static void main(String[] args) {
        TestRunner.run(TfsmClockTest.class);
    }
     ...
     * @generated
     */
    public TfsmClockTest(String name) {
        super(name);
    }
     ...
     */
    @Override
    protected TfsmClock getFixture() {
        return (TfsmClock)fixture;
    }
    ...
    protected void setUp() throws Exception {
        setFixture(TfsmFactory.eINSTANCE.createTfsmClock());
    }
