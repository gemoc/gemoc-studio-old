 ...
 * <ul>
 *   <li>{@link javasolverinput.impl.PrecedesImpl#getClock1 <em>Clock1</em>}</li>
 *   <li>{@link javasolverinput.impl.PrecedesImpl#getClock2 <em>Clock2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PrecedesImpl extends RelationImpl implements Precedes {
	/**
	...
	protected EClass eStaticClass() {
		return JavasolverinputPackage.Literals.PRECEDES;
	}
		...
		if (clock1 != null && clock1.eIsProxy()) {
			...
			if (clock1 != oldClock1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavasolverinputPackage.PRECEDES__CLOCK1, oldClock1, clock1));
			}
		}
		return clock1;
	}
	...
	public void setClock1(Clock newClock1) {
		...
		clock1 = newClock1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavasolverinputPackage.PRECEDES__CLOCK1, oldClock1, clock1));
	}
	...
	public Clock getClock2() {
		if (clock2 != null && clock2.eIsProxy()) {
			...
			if (clock2 != oldClock2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavasolverinputPackage.PRECEDES__CLOCK2, oldClock2, clock2));
			}
		}
		return clock2;
	}
	...
	public void setClock2(Clock newClock2) {
		...
		clock2 = newClock2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavasolverinputPackage.PRECEDES__CLOCK2, oldClock2, clock2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavasolverinputPackage.PRECEDES__CLOCK1:
				if (resolve) return getClock1();
				return basicGetClock1();
			case JavasolverinputPackage.PRECEDES__CLOCK2:
