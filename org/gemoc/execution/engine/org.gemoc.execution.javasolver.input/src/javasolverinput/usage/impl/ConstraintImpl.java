 ...
 * <ul>
 *   <li>{@link javasolverinput.usage.impl.ConstraintImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConstraintImpl extends NamedElementImpl implements Constraint {
	...
	protected EClass eStaticClass() {
		return UsagePackage.Literals.CONSTRAINT;
	}
	...
	public EList<EObject> getArguments() {
		if (arguments == null) {
			arguments = new EObjectResolvingEList<EObject>(EObject.class, this, UsagePackage.CONSTRAINT__ARGUMENTS);
		}
		return arguments;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UsagePackage.CONSTRAINT__ARGUMENTS:
				return getArguments();
		}
