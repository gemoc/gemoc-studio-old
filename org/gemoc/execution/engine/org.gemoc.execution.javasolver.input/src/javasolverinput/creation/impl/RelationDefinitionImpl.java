 ...
 * <ul>
 *   <li>{@link javasolverinput.creation.impl.RelationDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationDefinitionImpl extends MinimalEObjectImpl.Container implements RelationDefinition {
	...
	protected EClass eStaticClass() {
		return CreationPackage.Literals.RELATION_DEFINITION;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, CreationPackage.RELATION_DEFINITION__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CreationPackage.RELATION_DEFINITION__CONSTRAINTS:
