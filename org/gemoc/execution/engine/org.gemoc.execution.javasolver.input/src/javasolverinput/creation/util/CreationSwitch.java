 ...
 * @generated
 */
public class CreationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CreationPackage.RELATION_DECLARATION: {
			...
			case CreationPackage.PARAMETER: {
			...
			case CreationPackage.RELATION_DEFINITION: {
