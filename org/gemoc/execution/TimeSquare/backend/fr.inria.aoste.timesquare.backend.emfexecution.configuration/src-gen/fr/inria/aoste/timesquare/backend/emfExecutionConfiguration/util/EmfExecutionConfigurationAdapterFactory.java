...
public class EmfExecutionConfigurationAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected EmfExecutionConfigurationSwitch<Adapter> modelSwitch =
    new EmfExecutionConfigurationSwitch<Adapter>()
    {
      @Override
      public Adapter caseEMFExecutionConfiguration(EMFExecutionConfiguration object)
      {
        return createEMFExecutionConfigurationAdapter();
      }
      @Override
      public Adapter caseForcedClockMapping(ForcedClockMapping object)
      {
        return createForcedClockMappingAdapter();
      }
      @Override
      ...
      {
        return createJarImportStatementAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.EMFExecutionConfiguration <em>EMF Execution Configuration</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping <em>Forced Clock Mapping</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ImportStatement <em>Import Statement</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.JarImportStatement <em>Jar Import Statement</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
