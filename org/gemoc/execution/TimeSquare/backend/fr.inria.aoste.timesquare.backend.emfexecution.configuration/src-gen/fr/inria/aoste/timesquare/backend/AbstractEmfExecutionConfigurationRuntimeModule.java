...
/**
 * Manual modifications go to {fr.inria.aoste.timesquare.backend.EmfExecutionConfigurationRuntimeModule}
 */
...
public abstract class AbstractEmfExecutionConfigurationRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "fr/inria/aoste/timesquare/backend/EmfExecutionConfiguration.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("fr.inria.aoste.timesquare.backend.EmfExecutionConfiguration");
	}
	...
	public com.google.inject.Provider<fr.inria.aoste.timesquare.backend.parser.antlr.internal.InternalEmfExecutionConfigurationLexer> provideInternalEmfExecutionConfigurationLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(fr.inria.aoste.timesquare.backend.parser.antlr.internal.InternalEmfExecutionConfigurationLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(fr.inria.aoste.timesquare.backend.parser.antlr.internal.InternalEmfExecutionConfigurationLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends fr.inria.aoste.timesquare.backend.validation.EmfExecutionConfigurationJavaValidator> bindEmfExecutionConfigurationJavaValidator() {
