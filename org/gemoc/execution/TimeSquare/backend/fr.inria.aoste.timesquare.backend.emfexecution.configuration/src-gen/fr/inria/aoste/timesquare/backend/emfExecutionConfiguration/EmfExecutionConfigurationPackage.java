...
public interface EmfExecutionConfigurationPackage extends EPackage
{
   ...
   * @generated
   */
  EmfExecutionConfigurationPackage eINSTANCE = fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EmfExecutionConfigurationPackageImpl.init();

  /**
   * The meta object id for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EMFExecutionConfigurationImpl <em>EMF Execution Configuration</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The feature id for the '<em><b>Clock To Avoid When True</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>Forced Clock Mapping</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The meta object id for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.ImportStatementImpl <em>Import Statement</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.JarImportStatementImpl <em>Jar Import Statement</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The number of structural features of the '<em>Jar Import Statement</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.EMFExecutionConfiguration <em>EMF Execution Configuration</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.EMFExecutionConfiguration#getImports <em>Imports</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Forced Clock Mappings</em>'.
  ...
  /**
   * Returns the meta object for class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping <em>Forced Clock Mapping</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping#getClock <em>Clock</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ForcedClockMapping#getClockToAvoidWhenTrue <em>Clock To Avoid When True</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Clock To Avoid When True</em>'.
  ...
  /**
   * Returns the meta object for class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ImportStatement <em>Import Statement</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.ImportStatement#getImportURI <em>Import URI</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.JarImportStatement <em>Jar Import Statement</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.JarImportStatement#getPathToJar <em>Path To Jar</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  {
    /**
     * The meta object literal for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EMFExecutionConfigurationImpl <em>EMF Execution Configuration</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EMFExecutionConfigurationImpl
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EmfExecutionConfigurationPackageImpl#getEMFExecutionConfiguration()
     * @generated
     */
    EClass EMF_EXECUTION_CONFIGURATION = eINSTANCE.getEMFExecutionConfiguration();
     ...
     * @generated
     */
    EReference EMF_EXECUTION_CONFIGURATION__FORCED_CLOCK_MAPPINGS = eINSTANCE.getEMFExecutionConfiguration_ForcedClockMappings();

    /**
     * The meta object literal for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.ForcedClockMappingImpl <em>Forced Clock Mapping</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.ForcedClockMappingImpl
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EmfExecutionConfigurationPackageImpl#getForcedClockMapping()
     * @generated
     */
    EClass FORCED_CLOCK_MAPPING = eINSTANCE.getForcedClockMapping();
     ...
     * @generated
     */
    EReference FORCED_CLOCK_MAPPING__CLOCK = eINSTANCE.getForcedClockMapping_Clock();

    /**
     * The meta object literal for the '<em><b>Clock To Avoid When True</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference FORCED_CLOCK_MAPPING__CLOCK_TO_AVOID_WHEN_TRUE = eINSTANCE.getForcedClockMapping_ClockToAvoidWhenTrue();

    /**
     * The meta object literal for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.ImportStatementImpl <em>Import Statement</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.ImportStatementImpl
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EmfExecutionConfigurationPackageImpl#getImportStatement()
    ...
    /**
     * The meta object literal for the '{@link fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.JarImportStatementImpl <em>Jar Import Statement</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.JarImportStatementImpl
     * @see fr.inria.aoste.timesquare.backend.emfExecutionConfiguration.impl.EmfExecutionConfigurationPackageImpl#getJarImportStatement()
     * @generated
     */
    EClass JAR_IMPORT_STATEMENT = eINSTANCE.getJarImportStatement();

    /**
     * The meta object literal for the '<em><b>Path To Jar</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute JAR_IMPORT_STATEMENT__PATH_TO_JAR = eINSTANCE.getJarImportStatement_PathToJar();
