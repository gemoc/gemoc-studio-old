...
public class GemocLanguageProcessJavaTaskFactory {
	...
	Map<Task, AbstractActionProcessor> actionProcessors = new LinkedHashMap<Task, AbstractActionProcessor>();

	public Map<Task, AbstractActionProcessor> createJavaTaskForProcess(Process process) {
		Map<String, Task> taskByIDMap = ProcessUtils.getTaskByIDMap(process);

		addActionProcessor(new CreateNewGemocLanguageProjectTask((ActionTask)taskByIDMap
				.get("CreateNewGemocLanguageProjectTask")));
		...
		addActionProcessor(new EditEMFDomainConceptsTask((ActionTask)taskByIDMap
				.get("EditEMFDomainConceptsTask")));
		addActionProcessor(new SetDomainModelRootTask((ActionTask)taskByIDMap
				.get("SelectDomainModelRootTask")));
		addActionProcessor(new CreateNewEMFTreeEditorProjectTask((ActionTask)taskByIDMap
		 ...
		 * (ActionTask)taskByIDMap .get("Task2.b"))); addActionProcessor(new
		 * Task5b1((ActionTask)taskByIDMap.get("Task5.b.1"))); addActionProcessor(new
		 * Task5b2((ActionTask)taskByIDMap.get("Task5.b.2"))); addActionProcessor(new
		 * Task5b3((ActionTask)taskByIDMap.get("Task5.b.3"))); addActionProcessor(new
		 * Task5b4((ActionTask)taskByIDMap.get("Task5.b.4"))); addActionProcessor(new
		 * Task5c1((ActionTask)taskByIDMap.get("Task5.c.1"))); addActionProcessor(new
		 * Task5d((ActionTask)taskByIDMap.get("Task5.d"), (ActionTask)taskByIDMap .get("Task1")));
		 * addActionProcessor(new Task6a((ActionTask)taskByIDMap.get("Task6.a"))); addActionProcessor(new
		 * Task6b((ActionTask)taskByIDMap.get("Task6.b"))); addActionProcessor(new
		 * Task6c((ActionTask)taskByIDMap.get("Task6.c"), (ActionTask)taskByIDMap .get("Task1")));
		 * addActionProcessor(new Task7a((ActionTask)taskByIDMap.get("Task7.a"), (ActionTask)taskByIDMap
		 * .get("Task1"))); addActionProcessor(new Task7b((ActionTask)taskByIDMap.get("Task7.b"),
		 * (ActionTask)taskByIDMap .get("Task1"))); addActionProcessor(new
		 * Task8a1((ActionTask)taskByIDMap.get("Task8.a.1"), (ActionTask)taskByIDMap .get("Task1")));
		 * addActionProcessor(new Task8b((ActionTask)taskByIDMap.get("Task8.b"), (ActionTask)taskByIDMap
		 * .get("Task1"))); addActionProcessor(new Task8c((ActionTask)taskByIDMap.get("Task8.c"),
		 * (ActionTask)taskByIDMap .get("Task1"))); addActionProcessor(new
		 * Task9a((ActionTask)taskByIDMap.get("Task9.a"))); addActionProcessor(new
		 * Task9b((ActionTask)taskByIDMap.get("Task9.b"), (ActionTask)taskByIDMap .get("Task1")));
		 */
	 ...
	 */
	private void addActionProcessor(AbstractActionProcessor processor) {
