 ...
 */
public class DefineGraphicalEditorTask extends AbstractGemocActionProcessor {
	 ...
	 */
	public DefineGraphicalEditorTask(ActionTask task) {
		super(task);
	}
	...
	protected boolean internalValidate(GemocLanguageProcessContext context) {
		...
		if (project != null) {
			...
			undoneReason = "No Graphical Editor referenced in your xdsml file.";
		}
		return false;
	}
