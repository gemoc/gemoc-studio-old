...
public class DefineTextualEditorTask extends AbstractGemocActionProcessor {
	 ...
	 */
	public DefineTextualEditorTask(ActionTask task) {
		super(task);
	}
	...
	protected boolean internalValidate(GemocLanguageProcessContext context) {
		...
		if (project != null) {
			...
			undoneReason = "No Textual Editor referenced in your xdsml file.";
		}
		return false;
	}
	...
	protected void internalDoAction(GemocLanguageProcessContext context) {
		PlatformUI.getWorkbench().getHelpSystem().displayHelpResource(
				"/" + org.gemoc.gemoc_language_workbench.documentation.Activator.PLUGIN_ID
						+ "/eclipse_help/eclipse/ch01.html#_defining_a_concrete_syntax_with_xtext");
	}
