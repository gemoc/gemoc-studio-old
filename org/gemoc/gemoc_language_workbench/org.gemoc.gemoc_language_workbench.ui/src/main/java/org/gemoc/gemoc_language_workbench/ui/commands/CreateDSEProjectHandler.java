...
import org.gemoc.gemoc_language_workbench.ui.wizards.CreateDSEWizard;
import org.gemoc.gemoc_language_workbench.ui.wizards.CreateDSEWizardContextAction;

public class CreateDSEProjectHandler extends AbstractGemocLanguageProjectHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		WizardDialog wizardDialog = new WizardDialog(HandlerUtil.getActiveWorkbenchWindow(event).getShell(),
													 new CreateDSEWizard(new CreateDSEWizardContextAction(updatedGemocLanguageProject)));
		wizardDialog.open();
