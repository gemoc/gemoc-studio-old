...
public class TestXtextSerializer2 {
	...
	public static void loadGexpressionTestFile() {
		...
		// Load the model
		URI modelURI = URI
				.createFileURI("/home/flatombe/thesis/gemoc/git/gemoc-dev/org/gemoc/GEL/org.gemoc.gel.gexpressions.test/model/test.gexpressions");
	...
	//
	// URI uri = URI
	// .createFileURI("/home/flatombe/thesis/gemoc/git/gemoc-dev/org/gemoc/sample_deployed/TFSM/language_workbench/org.gemoc.sample.tfsm.dse/gel/domainSpecificEvents.GEL");
	// XtextResourceSet resSet = injector.getInstance(XtextResourceSet.class);
	// resSet.addLoadOption(XtextResource.OPTION_RESOLVE_ALL, Boolean.TRUE);
