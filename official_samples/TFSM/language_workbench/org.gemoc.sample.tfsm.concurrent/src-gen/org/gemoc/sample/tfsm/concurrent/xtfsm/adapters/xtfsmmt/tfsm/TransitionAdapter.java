...
public class TransitionAdapter extends EObjectAdapter<Transition> implements org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.Transition {
  ...
  public void setSource(final State o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.sample.tfsm.concurrent.xtfsm.adapters.xtfsmmt.tfsm.StateAdapter) o).getAdaptee());
  ...
  public void setTarget(final State o) {
    if (o != null)
    	adaptee.setTarget(((org.gemoc.sample.tfsm.concurrent.xtfsm.adapters.xtfsmmt.tfsm.StateAdapter) o).getAdaptee());
  ...
  public void setOwnedGuard(final Guard o) {
    if (o != null)
    	adaptee.setOwnedGuard(((org.gemoc.sample.tfsm.concurrent.xtfsm.adapters.xtfsmmt.tfsm.GuardAdapter) o).getAdaptee());
  ...
  @Override
  public String fire() {
    return org.gemoc.sample.tfsm.concurrent.xtfsm.aspects.TransitionAspect.fire(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.eINSTANCE.getTransition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__SOURCE:
    		return getSource();
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__TARGET:
    		return getTarget();
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__OWNED_GUARD:
    		return getOwnedGuard();
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__GENERATED_EVENTS:
    		return getGeneratedEvents();
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__ACTION:
    		return getAction();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__OWNED_GUARD:
    		setOwnedGuard(
    		(org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.Guard)
    		 newValue);
    		return;
    	case org.gemoc.sample.tfsm.concurrent.xtfsmmt.tfsm.TfsmPackage.TRANSITION__GENERATED_EVENTS:
