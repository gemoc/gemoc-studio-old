...
/**
 * This is the item provider adapter for a {@link org.gemoc.sample.sigpml.xsigpml.sigpml.HWComputationalResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addCurrentExecCyclePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HWComputationalResource_currentExecCycle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HWComputationalResource_currentExecCycle_feature", "_UI_HWComputationalResource_type"),
				 SigpmlPackage.Literals.HW_COMPUTATIONAL_RESOURCE__CURRENT_EXEC_CYCLE,
				 true,
				 false,
				 false,
