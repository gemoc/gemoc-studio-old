...
import org.gemoc.sample.sigpml.xsigpml.sigpml.sizeType;

import org.gemoc.sample.sigpml.xsigpml.sigpml.util.SigpmlValidator;
...
public class SigpmlPackageImpl extends EPackageImpl implements SigpmlPackage {
	 ...
	 * @see org.gemoc.sample.sigpml.xsigpml.sigpml.SigpmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getHWComputationalResource_CurrentExecCycle() {
		return (EAttribute)hwComputationalResourceEClass.getEStructuralFeatures().get(2);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAgent_IsCurrentlyExecuting(), ecorePackage.getEBoolean(), "isCurrentlyExecuting", null, 0, 1, Agent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(agentEClass, null, "isExecuting", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(agentEClass, null, "stop", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(placeEClass, null, "initialize", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(systemEClass, org.gemoc.sample.sigpml.xsigpml.sigpml.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_OwnedApplication(), this.getApplication(), null, "ownedApplication", null, 0, 1, org.gemoc.sample.sigpml.xsigpml.sigpml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_OwnedHWPlatform(), this.getHWPlatform(), null, "ownedHWPlatform", null, 0, 1, org.gemoc.sample.sigpml.xsigpml.sigpml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_SharedMemory(), this.getLinkedListMultimap(), "sharedMemory", null, 0, 1, org.gemoc.sample.sigpml.xsigpml.sigpml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = addEOperation(systemEClass, null, "initializeModel", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (agentEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
