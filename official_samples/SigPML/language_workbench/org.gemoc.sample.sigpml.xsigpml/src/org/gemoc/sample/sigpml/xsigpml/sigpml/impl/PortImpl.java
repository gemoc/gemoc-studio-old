 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PortImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PortImpl#getRate <em>Rate</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PortImpl#getByteRate <em>Byte Rate</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PortImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortImpl extends NamedElementImpl implements Port {
	...
	/**
	 * The cached value of the '{@link #getByteRate() <em>Byte Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getByteRate()
	 * @generated
	 * @ordered
	 */
	protected int byteRate = BYTE_RATE_EDEFAULT;
	...
	public void setByteRate(int newByteRate) {
		int oldByteRate = byteRate;
		byteRate = newByteRate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlPackage.PORT__BYTE_RATE, oldByteRate, byteRate));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SigpmlPackage.PORT__BYTE_RATE:
				return byteRate != BYTE_RATE_EDEFAULT;
			case SigpmlPackage.PORT__TYPE:
