 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getItsOutputPort <em>Its Output Port</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getItsInputPort <em>Its Input Port</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getByteSize <em>Byte Size</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getFifo <em>Fifo</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#getCurrentSize <em>Current Size</em>}</li>
 *   <li>{@link org.gemoc.sample.sigpml.xsigpml.sigpml.impl.PlaceImpl#isIsInitialized <em>Is Initialized</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends NamedElementImpl implements Place {
	...
	public void setByteSize(int newByteSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SigpmlPackage.PLACE__BYTE_SIZE, oldByteSize, byteSize));
	}
