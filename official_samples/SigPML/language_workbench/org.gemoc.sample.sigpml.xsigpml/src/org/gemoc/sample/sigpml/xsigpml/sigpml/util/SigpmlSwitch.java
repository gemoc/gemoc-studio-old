...
public class SigpmlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SigpmlPackage.SYSTEM: {
				org.gemoc.sample.sigpml.xsigpml.sigpml.System system = (org.gemoc.sample.sigpml.xsigpml.sigpml.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(org.gemoc.sample.sigpml.xsigpml.sigpml.System object) {
		return null;
	}
