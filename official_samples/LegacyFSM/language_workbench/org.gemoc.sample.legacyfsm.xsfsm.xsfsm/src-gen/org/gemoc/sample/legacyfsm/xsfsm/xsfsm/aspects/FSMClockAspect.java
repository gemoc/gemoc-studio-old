...
public class FSMClockAspect {
  ...
  public static Integer ticks(final FSMClock _self) {
	final org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.FSMClockAspectFSMClockAspectProperties _self_ = org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.FSMClockAspectFSMClockAspectContext
			.getSelf(_self);
	Object result = null;
