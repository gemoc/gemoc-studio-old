 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.FSMEventImpl#getSollicitingTransitions <em>Solliciting Transitions</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.FSMEventImpl#isIsTriggered <em>Is Triggered</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FSMEventImpl extends NamedElementImpl implements FSMEvent {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.FSM_EVENT;
	}
	...
	public EList<Transition> getSollicitingTransitions() {
		if (sollicitingTransitions == null) {
			sollicitingTransitions = new EObjectResolvingEList<Transition>(Transition.class, this, FsmPackage.FSM_EVENT__SOLLICITING_TRANSITIONS);
		}
	...
	public void setIsTriggered(boolean newIsTriggered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.FSM_EVENT__IS_TRIGGERED, oldIsTriggered, isTriggered));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.FSM_EVENT__SOLLICITING_TRANSITIONS:
				return getSollicitingTransitions();
			case FsmPackage.FSM_EVENT__IS_TRIGGERED:
