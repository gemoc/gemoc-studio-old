 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.EvaluateGuardImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvaluateGuardImpl extends GuardImpl implements EvaluateGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.EVALUATE_GUARD;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.EVALUATE_GUARD__CONDITION, oldCondition, condition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.EVALUATE_GUARD__CONDITION:
				return getCondition();
		}
