...
public class TransitionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsmPackage.Literals.TRANSITION__GENERATED_EVENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.TRANSITION__OWNED_GUARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 FsmFactory.eINSTANCE.createTemporalGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 FsmFactory.eINSTANCE.createEventGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__OWNED_GUARD,
				 FsmFactory.eINSTANCE.createEvaluateGuard()));
	}
