 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTimeFSMImpl#getCurrentStateSequence <em>Current State Sequence</em>}</li>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTimeFSMImpl#getLastStateChangeStepNumberSequence <em>Last State Change Step Number Sequence</em>}</li>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTimeFSMImpl#getOriginalObject <em>Original Object</em>}</li>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTimeFSMImpl#getStepNumberSequence <em>Step Number Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedTimeFSMImpl extends TracedNamedElementImpl implements TracedTimeFSM {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TRACED_TIME_FSM;
	}
	...
	public EList<TimeFSM_currentState_Value> getCurrentStateSequence() {
		if (currentStateSequence == null) {
			currentStateSequence = new EObjectContainmentWithInverseEList<TimeFSM_currentState_Value>(TimeFSM_currentState_Value.class, this, FsmPackage.TRACED_TIME_FSM__CURRENT_STATE_SEQUENCE, StatesPackage.TIME_FSM_CURRENT_STATE_VALUE__PARENT);
		}
	...
	public EList<TimeFSM_lastStateChangeStepNumber_Value> getLastStateChangeStepNumberSequence() {
		if (lastStateChangeStepNumberSequence == null) {
			lastStateChangeStepNumberSequence = new EObjectContainmentWithInverseEList<TimeFSM_lastStateChangeStepNumber_Value>(TimeFSM_lastStateChangeStepNumber_Value.class, this, FsmPackage.TRACED_TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER_SEQUENCE, StatesPackage.TIME_FSM_LAST_STATE_CHANGE_STEP_NUMBER_VALUE__PARENT);
		}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRACED_TIME_FSM__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(TimeFSM newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRACED_TIME_FSM__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public EList<TimeFSM_stepNumber_Value> getStepNumberSequence() {
		if (stepNumberSequence == null) {
			stepNumberSequence = new EObjectContainmentWithInverseEList<TimeFSM_stepNumber_Value>(TimeFSM_stepNumber_Value.class, this, FsmPackage.TRACED_TIME_FSM__STEP_NUMBER_SEQUENCE, StatesPackage.TIME_FSM_STEP_NUMBER_VALUE__PARENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FsmPackage.TRACED_TIME_FSM__ORIGINAL_OBJECT:
