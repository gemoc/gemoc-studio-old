 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedEventGuardImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedEventGuardImpl extends TracedGuardImpl implements TracedEventGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TRACED_EVENT_GUARD;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRACED_EVENT_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(EventGuard newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRACED_EVENT_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.TRACED_EVENT_GUARD__ORIGINAL_OBJECT:
