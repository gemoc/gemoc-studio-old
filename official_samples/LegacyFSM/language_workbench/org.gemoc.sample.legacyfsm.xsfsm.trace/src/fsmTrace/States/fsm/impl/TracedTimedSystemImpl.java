 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTimedSystemImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedTimedSystemImpl extends TracedNamedElementImpl implements TracedTimedSystem {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TRACED_TIMED_SYSTEM;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRACED_TIMED_SYSTEM__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(TimedSystem newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRACED_TIMED_SYSTEM__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.TRACED_TIMED_SYSTEM__ORIGINAL_OBJECT:
