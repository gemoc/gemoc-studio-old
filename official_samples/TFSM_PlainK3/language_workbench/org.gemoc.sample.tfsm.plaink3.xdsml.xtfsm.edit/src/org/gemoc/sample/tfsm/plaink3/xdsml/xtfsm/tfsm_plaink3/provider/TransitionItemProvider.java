...
/**
 * This is the item provider adapter for a {@link org.gemoc.sample.tfsm.plaink3.xdsml.xtfsm.tfsm_plaink3.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Tfsm_plaink3Package.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Tfsm_plaink3Package.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Tfsm_plaink3Package.Literals.TRANSITION__GENERATED_EVENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Tfsm_plaink3Package.Literals.TRANSITION__ACTION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Tfsm_plaink3Package.Literals.TRANSITION__OWNED_GUARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Tfsm_plaink3Package.Literals.TRANSITION__OWNED_GUARD,
				 Tfsm_plaink3Factory.eINSTANCE.createTemporalGuard()));

		newChildDescriptors.add
			(createChildParameter
				(Tfsm_plaink3Package.Literals.TRANSITION__OWNED_GUARD,
				 Tfsm_plaink3Factory.eINSTANCE.createEventGuard()));

		newChildDescriptors.add
			(createChildParameter
				(Tfsm_plaink3Package.Literals.TRANSITION__OWNED_GUARD,
				 Tfsm_plaink3Factory.eINSTANCE.createEvaluateGuard()));
	}
