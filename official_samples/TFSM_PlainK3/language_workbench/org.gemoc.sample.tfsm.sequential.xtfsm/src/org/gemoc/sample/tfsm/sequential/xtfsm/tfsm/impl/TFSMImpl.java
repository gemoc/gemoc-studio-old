 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getOwnedStates <em>Owned States</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getInitialState <em>Initial State</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getLocalEvents <em>Local Events</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getLocalClock <em>Local Clock</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getOwnedTransitions <em>Owned Transitions</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getCurrentState <em>Current State</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getStepNumber <em>Step Number</em>}</li>
 *   <li>{@link org.gemoc.sample.tfsm.sequential.xtfsm.tfsm.impl.TFSMImpl#getLastStateChangeStepNumber <em>Last State Change Step Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFSMImpl extends NamedElementImpl implements TFSM {
	...
	public void setStepNumber(int newStepNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TFSM__STEP_NUMBER, oldStepNumber, stepNumber));
	}
	...
	public void setLastStateChangeStepNumber(int newLastStateChangeStepNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TFSM__LAST_STATE_CHANGE_STEP_NUMBER, oldLastStateChangeStepNumber, lastStateChangeStepNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmPackage.TFSM__STEP_NUMBER:
				return getStepNumber();
			case TfsmPackage.TFSM__LAST_STATE_CHANGE_STEP_NUMBER:
