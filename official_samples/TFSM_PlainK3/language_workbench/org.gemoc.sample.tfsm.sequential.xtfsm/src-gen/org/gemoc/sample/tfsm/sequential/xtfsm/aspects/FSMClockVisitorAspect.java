...
public class FSMClockVisitorAspect {
  public static void visit(final FSMClock _self) {
    final org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMClockVisitorAspectFSMClockAspectProperties _self_ = org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMClockVisitorAspectFSMClockAspectContext.getSelf(_self);
