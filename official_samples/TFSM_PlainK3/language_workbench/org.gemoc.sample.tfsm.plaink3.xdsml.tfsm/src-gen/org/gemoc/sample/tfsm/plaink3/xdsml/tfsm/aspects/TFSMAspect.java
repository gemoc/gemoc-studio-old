...
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMAspectTFSMAspectProperties;
...
public class TFSMAspect {
  ...
  public static void init(final TFSM _self) {
    final org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMAspectTFSMAspectProperties _self_ = org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMAspectTFSMAspectContext.getSelf(_self);
  ...
  protected static void _privk3_init(final TFSMAspectTFSMAspectProperties _self_, final TFSM _self) {
    ...
    _self.setCurrentState(_initialState);
    FSMClock _localClock = _self.getLocalClock();
    _localClock.setNumberOfTicks(Integer.valueOf(0));
