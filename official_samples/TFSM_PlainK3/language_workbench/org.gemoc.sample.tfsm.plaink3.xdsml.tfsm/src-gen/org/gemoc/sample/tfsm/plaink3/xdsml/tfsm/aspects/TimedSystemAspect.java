...
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMEventAspect;
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMAspect;
...
public class TimedSystemAspect {
  ...
  public static void main(final TimedSystem _self) {
    final org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspectTimedSystemAspectProperties _self_ = org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspectTimedSystemAspectContext.getSelf(_self);
    _privk3_main(_self_, _self);;
  }
  
  @InitializeModel
  public static void initializeModel(final TimedSystem _self, final List<String> args) {
    final org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspectTimedSystemAspectProperties _self_ = org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspectTimedSystemAspectContext.getSelf(_self);
  ...
  protected static void _privk3_initializeModel(final TimedSystemAspectTimedSystemAspectProperties _self_, final TimedSystem _self, final List<String> args) {
    EList<TFSM> _tfsms = _self.getTfsms();
    final TFSM tfsm = _tfsms.get(0);
