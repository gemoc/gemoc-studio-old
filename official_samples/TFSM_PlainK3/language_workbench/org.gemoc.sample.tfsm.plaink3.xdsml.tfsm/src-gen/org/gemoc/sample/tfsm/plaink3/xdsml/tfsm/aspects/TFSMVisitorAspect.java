...
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMClockVisitorAspect;
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.StateVisitorAspect;
import org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMVisitorAspectTFSMAspectProperties;
...
public class TFSMVisitorAspect {
  public static void visit(final TFSM _self) {
    final org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMVisitorAspectTFSMAspectProperties _self_ = org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TFSMVisitorAspectTFSMAspectContext.getSelf(_self);
  ...
  protected static void _privk3_visit(final TFSMVisitorAspectTFSMAspectProperties _self_, final TFSM _self) {
    ...
    State _currentState = _self.getCurrentState();
  ...
  protected static String _privk3_getCurrentStateName(final TFSMVisitorAspectTFSMAspectProperties _self_, final TFSM _self) {
    ...
    if (_notEquals) {
      State _currentState_1 = _self.getCurrentState();
