...
public class TransitionAspect {
  ...
  public static void fire(final Transition _self) {
    final org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TransitionAspectTransitionAspectProperties _self_ = org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TransitionAspectTransitionAspectContext.getSelf(_self);
  ...
  protected static void _privk3_fire(final TransitionAspectTransitionAspectProperties _self_, final Transition _self) {
    ...
    _owningFSM.setCurrentState(_target);
