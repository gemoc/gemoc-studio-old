...
public class EventGuardVisitorAspectEventGuardAspectContext {
  ...
  public static EventGuardVisitorAspectEventGuardAspectProperties getSelf(final EventGuard _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.EventGuardVisitorAspectEventGuardAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<EventGuard, EventGuardVisitorAspectEventGuardAspectProperties> map = new java.util.WeakHashMap<org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EventGuard, org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.EventGuardVisitorAspectEventGuardAspectProperties>();
