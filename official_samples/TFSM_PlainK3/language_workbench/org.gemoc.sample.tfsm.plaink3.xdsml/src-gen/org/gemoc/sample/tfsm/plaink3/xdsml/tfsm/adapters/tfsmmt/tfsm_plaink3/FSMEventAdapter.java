...
public class FSMEventAdapter extends EObjectAdapter<FSMEvent> implements org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.FSMEvent {
  ...
  public boolean isIsTriggered() {
    return org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMEventAspect.isTriggered(adaptee);
  }
  
  @Override
  public void setIsTriggered(final boolean isTriggered) {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMEventAspect.isTriggered(adaptee, isTriggered
    );
  }
  
  @Override
  public void trigger() {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMEventAspect.trigger(adaptee);
  }
  
  @Override
  public void unTrigger() {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.FSMEventAspect.unTrigger(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.eINSTANCE.getFSMEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.FSM_EVENT__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.FSM_EVENT__SOLLICITING_TRANSITIONS:
    		return getSollicitingTransitions();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.FSM_EVENT__IS_TRIGGERED:
