...
public class TemporalGuardAdapter extends EObjectAdapter<TemporalGuard> implements org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.TemporalGuard {
  ...
  public void setOnClock(final FSMClock o) {
    if (o != null)
    	adaptee.setOnClock(((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.adapters.tfsmmt.tfsm_plaink3.FSMClockAdapter) o).getAdaptee());
    else adaptee.setOnClock(null);
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TemporalGuardVisitorAspect.visit(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.eINSTANCE.getTemporalGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TEMPORAL_GUARD__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TEMPORAL_GUARD__ON_CLOCK:
    		return getOnClock();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TEMPORAL_GUARD__AFTER_DURATION:
