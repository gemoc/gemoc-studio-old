...
public class TimedSystemAdapter extends EObjectAdapter<TimedSystem> implements org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.TimedSystem {
  ...
  public void initializeModel(final org.eclipse.emf.common.util.EList<java.lang.String> args) {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspect.initializeModel(adaptee, args
    );
  }
  
  @Override
  public void main() {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemAspect.main(adaptee);
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.aspects.TimedSystemVisitorAspect.visit(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.eINSTANCE.getTimedSystem();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TIMED_SYSTEM__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TIMED_SYSTEM__TFSMS:
    		return getTfsms();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TIMED_SYSTEM__GLOBAL_CLOCKS:
    		return getGlobalClocks();
    	case org.gemoc.sample.tfsm.plaink3.xdsml.tfsmmt.tfsm_plaink3.Tfsm_plaink3Package.TIMED_SYSTEM__GLOBAL_EVENTS:
