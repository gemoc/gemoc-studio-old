 ...
 *   <li>{@link tfsmTrace.States.State#getTFSM_currentState_Values <em>TFSM current State Values</em>}</li>
 *   <li>{@link tfsmTrace.States.State#getTFSM_lastStateChangeStepNumber_Values <em>TFSM last State Change Step Number Values</em>}</li>
 *   <li>{@link tfsmTrace.States.State#getTFSM_stepNumber_Values <em>TFSM step Number Values</em>}</li>
 * </ul>
 *
...
public interface State extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TFSM_currentState_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.StatesPackage#getState_TFSM_currentState_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TFSM_lastStateChangeStepNumber_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.StatesPackage#getState_TFSM_lastStateChangeStepNumber_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TFSM_stepNumber_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.StatesPackage#getState_TFSM_stepNumber_Values()
