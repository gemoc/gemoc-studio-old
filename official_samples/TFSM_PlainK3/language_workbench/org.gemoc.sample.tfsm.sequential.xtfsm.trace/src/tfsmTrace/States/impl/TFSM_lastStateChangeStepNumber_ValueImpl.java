 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.TFSM_lastStateChangeStepNumber_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_lastStateChangeStepNumber_ValueImpl#getLastStateChangeStepNumber <em>Last State Change Step Number</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_lastStateChangeStepNumber_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_lastStateChangeStepNumber_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFSM_lastStateChangeStepNumber_ValueImpl extends MinimalEObjectImpl.Container implements TFSM_lastStateChangeStepNumber_Value {
	...
	public void setParent(TracedTFSM newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TFSM_LAST_STATE_CHANGE_STEP_NUMBER_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_TFSM__LAST_STATE_CHANGE_STEP_NUMBER_SEQUENCE, TracedTFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TFSM_LAST_STATE_CHANGE_STEP_NUMBER_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_TFSM__LAST_STATE_CHANGE_STEP_NUMBER_SEQUENCE, TracedTFSM.class, msgs);
		}
