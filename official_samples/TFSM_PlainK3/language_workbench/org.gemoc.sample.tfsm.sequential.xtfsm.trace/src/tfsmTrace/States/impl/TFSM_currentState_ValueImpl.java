 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.TFSM_currentState_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_currentState_ValueImpl#getCurrentState <em>Current State</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_currentState_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_currentState_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFSM_currentState_ValueImpl extends MinimalEObjectImpl.Container implements TFSM_currentState_Value {
	...
	public void setParent(TracedTFSM newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TFSM_CURRENT_STATE_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_TFSM__CURRENT_STATE_SEQUENCE, TracedTFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TFSM_CURRENT_STATE_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_TFSM__CURRENT_STATE_SEQUENCE, TracedTFSM.class, msgs);
		}
