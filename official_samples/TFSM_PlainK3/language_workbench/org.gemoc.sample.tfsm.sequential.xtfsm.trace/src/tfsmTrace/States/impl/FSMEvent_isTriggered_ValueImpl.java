 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.FSMEvent_isTriggered_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMEvent_isTriggered_ValueImpl#isIsTriggered <em>Is Triggered</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMEvent_isTriggered_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMEvent_isTriggered_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FSMEvent_isTriggered_ValueImpl extends MinimalEObjectImpl.Container implements FSMEvent_isTriggered_Value {
	...
	public void setParent(TracedFSMEvent newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.FSM_EVENT_IS_TRIGGERED_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_FSM_EVENT__IS_TRIGGERED_SEQUENCE, TracedFSMEvent.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.FSM_EVENT_IS_TRIGGERED_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_FSM_EVENT__IS_TRIGGERED_SEQUENCE, TracedFSMEvent.class, msgs);
		}
