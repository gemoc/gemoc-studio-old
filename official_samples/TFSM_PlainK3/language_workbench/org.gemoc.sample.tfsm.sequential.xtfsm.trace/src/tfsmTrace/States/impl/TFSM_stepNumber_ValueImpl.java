 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.TFSM_stepNumber_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_stepNumber_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_stepNumber_ValueImpl#getStates <em>States</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TFSM_stepNumber_ValueImpl#getStepNumber <em>Step Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFSM_stepNumber_ValueImpl extends MinimalEObjectImpl.Container implements TFSM_stepNumber_Value {
	...
	public void setParent(TracedTFSM newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TFSM_STEP_NUMBER_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_TFSM__STEP_NUMBER_SEQUENCE, TracedTFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TFSM_STEP_NUMBER_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_TFSM__STEP_NUMBER_SEQUENCE, TracedTFSM.class, msgs);
		}
