 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.tfsm.impl.TracedFSMEventImpl#getIsTriggeredSequence <em>Is Triggered Sequence</em>}</li>
 *   <li>{@link tfsmTrace.States.tfsm.impl.TracedFSMEventImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedFSMEventImpl extends TracedNamedElementImpl implements TracedFSMEvent {
	...
	protected EClass eStaticClass() {
		return TfsmPackage.Literals.TRACED_FSM_EVENT;
	}
	...
	public EList<FSMEvent_isTriggered_Value> getIsTriggeredSequence() {
		if (isTriggeredSequence == null) {
			isTriggeredSequence = new EObjectContainmentWithInverseEList<FSMEvent_isTriggered_Value>(FSMEvent_isTriggered_Value.class, this, TfsmPackage.TRACED_FSM_EVENT__IS_TRIGGERED_SEQUENCE, StatesPackage.FSM_EVENT_IS_TRIGGERED_VALUE__PARENT);
		}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmPackage.TRACED_FSM_EVENT__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(FSMEvent newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRACED_FSM_EVENT__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TfsmPackage.TRACED_FSM_EVENT__IS_TRIGGERED_SEQUENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmPackage.TRACED_FSM_EVENT__ORIGINAL_OBJECT:
