...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tfsm Transition Visit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.Steps.impl.Tfsm_Transition_VisitImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link tfsmTrace.Steps.impl.Tfsm_Transition_VisitImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link tfsmTrace.Steps.impl.Tfsm_Transition_VisitImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tfsm_Transition_VisitImpl extends StepImpl implements Tfsm_Transition_Visit {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Tfsm_Transition_Visit_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Tfsm_Transition_VisitImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.TFSM_TRANSITION_VISIT;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.TFSM_TRANSITION_VISIT__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.TFSM_TRANSITION_VISIT__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.TFSM_TRANSITION_VISIT__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.TFSM_TRANSITION_VISIT__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.TFSM_TRANSITION_VISIT__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.TFSM_TRANSITION_VISIT__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Tfsm_Transition_Visit_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Tfsm_Transition_Visit_AbstractSubStep>(Tfsm_Transition_Visit_AbstractSubStep.class, this, StepsPackage.TFSM_TRANSITION_VISIT__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public TracedTransition getCaller() {
		return (tfsmTrace.States.tfsm.TracedTransition) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.TFSM_TRANSITION_VISIT__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.TFSM_TRANSITION_VISIT__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.TFSM_TRANSITION_VISIT__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.TFSM_TRANSITION_VISIT__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Tfsm_Transition_Visit_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.TFSM_TRANSITION_VISIT__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
		...
		if (baseClass == Tfsm_State_Visit_AbstractSubStep.class) {
			switch (derivedFeatureID) {
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.TFSM_TRANSITION_VISIT__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
