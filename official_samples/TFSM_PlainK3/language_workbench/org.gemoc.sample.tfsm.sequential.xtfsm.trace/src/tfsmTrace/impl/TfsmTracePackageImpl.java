...
public class TfsmTracePackageImpl extends EPackageImpl implements TfsmTracePackage {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Tfsm_TFSM_Init_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Tfsm_tracedTFSMs() {
	...
	public void createPackageContents() {
		...
		createEReference(specificTraceEClass, SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE);
		...
		createEReference(specificTraceEClass, SPECIFIC_TRACE__TFSM_TRACED_TFS_MS);
	...
	public void initializePackageContents() {
		...
		initEReference(getSpecificTrace_Tfsm_TFSM_Init_Sequence(), theStepsPackage.getTfsm_TFSM_Init(), null, "Tfsm_TFSM_Init_Sequence", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpecificTrace_Tfsm_tracedTFSMs(), theTfsmPackage_1.getTracedTFSM(), null, "tfsm_tracedTFSMs", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
