 ...
 *   <li>{@link tfsmTrace.impl.SpecificTraceImpl#getTfsm_TFSM_Init_Sequence <em>Tfsm TFSM Init Sequence</em>}</li>
 ...
 *   <li>{@link tfsmTrace.impl.SpecificTraceImpl#getTfsm_tracedTFSMs <em>Tfsm traced TFS Ms</em>}</li>
...
public class SpecificTraceImpl extends TraceImpl<SequentialStep<SpecificStep>> implements SpecificTrace {
	...
	/**
	 * The cached value of the '{@link #getTfsm_TFSM_Init_Sequence() <em>Tfsm TFSM Init Sequence</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTfsm_TFSM_Init_Sequence()
	 * @generated
	 * @ordered
	 */
	protected EList<Tfsm_TFSM_Init> tfsm_TFSM_Init_Sequence;
	...
	/**
	 * The cached value of the '{@link #getTfsm_tracedTFSMs() <em>Tfsm traced TFS Ms</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTfsm_tracedTFSMs()
	 * @generated
	 * @ordered
	 */
	protected EList<TracedTFSM> tfsm_tracedTFSMs;
	 ...
	 * @generated
	 */
	public EList<Tfsm_TFSM_Init> getTfsm_TFSM_Init_Sequence() {
		if (tfsm_TFSM_Init_Sequence == null) {
			tfsm_TFSM_Init_Sequence = new EObjectResolvingEList<Tfsm_TFSM_Init>(Tfsm_TFSM_Init.class, this, TfsmTracePackage.SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE);
		}
		return tfsm_TFSM_Init_Sequence;
	}
	 ...
	 * @generated
	 */
	public EList<TracedTFSM> getTfsm_tracedTFSMs() {
		if (tfsm_tracedTFSMs == null) {
			tfsm_tracedTFSMs = new EObjectContainmentEList<TracedTFSM>(TracedTFSM.class, this, TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TFS_MS);
		}
		return tfsm_tracedTFSMs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TFS_MS:
				return ((InternalEList<?>)getTfsm_tracedTFSMs()).basicRemove(otherEnd, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE:
				return getTfsm_TFSM_Init_Sequence();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_STATE_VISIT_SEQUENCE:
				...
				return;
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE:
				getTfsm_TFSM_Init_Sequence().clear();
				getTfsm_TFSM_Init_Sequence().addAll((Collection<? extends Tfsm_TFSM_Init>)newValue);
				return;
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRANSITION_FIRE_SEQUENCE:
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_STATES:
				...
				return;
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TFS_MS:
				getTfsm_tracedTFSMs().clear();
				getTfsm_tracedTFSMs().addAll((Collection<? extends TracedTFSM>)newValue);
				return;
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TEMPORAL_GUARDS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE:
				return tfsm_TFSM_Init_Sequence != null && !tfsm_TFSM_Init_Sequence.isEmpty();
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRANSITION_FIRE_SEQUENCE:
			...
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TFS_MS:
				return tfsm_tracedTFSMs != null && !tfsm_tracedTFSMs.isEmpty();
			case TfsmTracePackage.SPECIFIC_TRACE__TFSM_TRACED_TEMPORAL_GUARDS:
