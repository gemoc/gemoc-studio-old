...
public interface TfsmTracePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Tfsm TFSM Init Sequence</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE = TracePackage.TRACE_FEATURE_COUNT + 4;
	...
	/**
	 * The feature id for the '<em><b>Tfsm traced TFS Ms</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFIC_TRACE__TFSM_TRACED_TFS_MS = TracePackage.TRACE_FEATURE_COUNT + 13;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__TFSM_TRACED_TEMPORAL_GUARDS = TracePackage.TRACE_FEATURE_COUNT + 14;
	...
	/**
	 * Returns the meta object for the reference list '{@link tfsmTrace.SpecificTrace#getTfsm_TFSM_Init_Sequence <em>Tfsm TFSM Init Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Tfsm TFSM Init Sequence</em>'.
	 * @see tfsmTrace.SpecificTrace#getTfsm_TFSM_Init_Sequence()
	 * @see #getSpecificTrace()
	 * @generated
	 */
	EReference getSpecificTrace_Tfsm_TFSM_Init_Sequence();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link tfsmTrace.SpecificTrace#getTfsm_tracedTFSMs <em>Tfsm traced TFS Ms</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Tfsm traced TFS Ms</em>'.
	 * @see tfsmTrace.SpecificTrace#getTfsm_tracedTFSMs()
	 * @see #getSpecificTrace()
	 * @generated
	 */
	EReference getSpecificTrace_Tfsm_tracedTFSMs();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Tfsm TFSM Init Sequence</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SPECIFIC_TRACE__TFSM_TFSM_INIT_SEQUENCE = eINSTANCE.getSpecificTrace_Tfsm_TFSM_Init_Sequence();
		...
		/**
		 * The meta object literal for the '<em><b>Tfsm traced TFS Ms</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SPECIFIC_TRACE__TFSM_TRACED_TFS_MS = eINSTANCE.getSpecificTrace_Tfsm_tracedTFSMs();
