		...
		if (eObject instanceof tfsm_plaink3Trace.States.State) {
			...
			for (tfsm_plaink3Trace.States.TFSM_currentState_Value value : stateToGo.getTFSM_currentState_Values()) {
				if (value.getParent() instanceof tfsm_plaink3Trace.States.tfsm_plaink3.TracedTFSM) {
					tfsm_plaink3Trace.States.tfsm_plaink3.TracedTFSM parent_cast = (tfsm_plaink3Trace.States.tfsm_plaink3.TracedTFSM) value
							.getParent();
					org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State toset = (org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) getTracedToExe(
							value.getCurrentState());
					org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State current = ((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) parent_cast
							.getOriginalObject()).getCurrentState();
					if (current != toset) {
						((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) parent_cast.getOriginalObject())
								.setCurrentState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) toset);
					}
				}
			}
			for (tfsm_plaink3Trace.States.FSMEvent_isTriggered_Value value : stateToGo
				...
				if (value.getParent() instanceof tfsm_plaink3Trace.States.tfsm_plaink3.TracedFSMEvent) {
					...
					boolean current = ((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) parent_cast
							.getOriginalObject()).isIsTriggered();
					if (current != toset) {
						((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) parent_cast
			...
			for (tfsm_plaink3Trace.States.TFSM_lastStateChangeStepNumber_Value value : stateToGo
				...
				if (value.getParent() instanceof tfsm_plaink3Trace.States.tfsm_plaink3.TracedTFSM) {
					...
					int current = ((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) parent_cast
			...
			for (tfsm_plaink3Trace.States.FSMClock_numberOfTicks_Value value : stateToGo
				...
				if (value.getParent() instanceof tfsm_plaink3Trace.States.tfsm_plaink3.TracedFSMClock) {
					...
					java.lang.Integer current = ((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) parent_cast
							.getOriginalObject()).getNumberOfTicks();
					if (current != toset) {
						((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) parent_cast
