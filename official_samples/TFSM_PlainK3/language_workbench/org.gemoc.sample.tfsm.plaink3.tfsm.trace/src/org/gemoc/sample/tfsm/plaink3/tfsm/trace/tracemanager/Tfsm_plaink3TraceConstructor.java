...
public class Tfsm_plaink3TraceConstructor implements ITraceConstructor {
		...
		if (lastState == null) {
			...
			for (Resource r : allResources) {
				for (TreeIterator<EObject> i = r.getAllContents(); i.hasNext();) {
					...
					if (o instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.NamedElement) {
						org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.NamedElement o_cast = (org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.NamedElement) o;
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EvaluateGuard o_cast,
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject
					.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EvaluateGuard) o_cast);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EventGuard o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EventGuard) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Guard o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TemporalGuard) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TemporalGuard) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EventGuard) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EventGuard) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EvaluateGuard) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.EvaluateGuard) o_cast,
					newState);
		}
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.NamedElement o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Transition) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Transition) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TimedSystem) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TimedSystem) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) o_cast, newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) o_cast, newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Guard) {
			added = addNewObjectToState((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Guard) o_cast, newState);
		}

		return added;
	}// end addNewObjectToState

	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			tfsm_plaink3Trace.States.tfsm_plaink3.TracedState tracedObject = tfsm_plaink3Trace.States.tfsm_plaink3.Tfsm_plaink3Factory.eINSTANCE
					.createTracedState();
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			tfsm_plaink3Trace.States.tfsm_plaink3.TracedTFSM tracedObject = tfsm_plaink3Trace.States.tfsm_plaink3.Tfsm_plaink3Factory.eINSTANCE
					.createTracedTFSM();
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) o_cast);
			exeToTraced.put(o_cast, tracedObject);
			...
			if (o_cast.getCurrentState() != null) {
				addNewObjectToState(
						(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.State) o_cast.getCurrentState(),
						newState);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TemporalGuard o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject
					.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TemporalGuard) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TimedSystem o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TimedSystem) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Transition o_cast,
			tfsm_plaink3Trace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Transition) o_cast);
			exeToTraced.put(o_cast, tracedObject);
			...
			for (org.gemoc.xdsmlframework.api.engine_addon.modelchangelistener.ModelChange modelChange : changes) {
				...
				if (modelChange instanceof org.gemoc.xdsmlframework.api.engine_addon.modelchangelistener.NonCollectionFieldModelChange) {
					...
					if (o instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) {
						org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent o_cast = (org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMEvent) o;

						if (p.getFeatureID() == org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.Tfsm_plaink3Package.eINSTANCE
					...
					if (o instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) {
						org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM o_cast = (org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.TFSM) o;
					...
					if (o instanceof org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) {
						org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock o_cast = (org.gemoc.sample.tfsm.plaink3.xdsml.tfsm.tfsm_plaink3.FSMClock) o;
