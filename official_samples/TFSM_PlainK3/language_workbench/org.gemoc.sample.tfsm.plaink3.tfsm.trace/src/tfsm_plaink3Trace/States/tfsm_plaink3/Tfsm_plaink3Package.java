...
public interface Tfsm_plaink3Package extends EPackage {
	 ...
	 * @ordered
	 */
	int TRACED_FSM_EVENT__SOLLICITING_TRANSITIONS = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TRACED_FSM_EVENT_FEATURE_COUNT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRACED_TFSM__ORIGINAL_OBJECT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int TRACED_TFSM__OWNED_STATES = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int TRACED_TFSM__OWNED_TRANSITIONS = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int TRACED_TFSM_FEATURE_COUNT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 8;
