 ...
 * </p>
 * <ul>
 *   <li>{@link tfsm_plaink3Trace.States.tfsm_plaink3.impl.TracedStateImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedStateImpl extends TracedNamedElementImpl implements TracedState {
	...
	protected EClass eStaticClass() {
		return Tfsm_plaink3Package.Literals.TRACED_STATE;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Tfsm_plaink3Package.TRACED_STATE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(State newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tfsm_plaink3Package.TRACED_STATE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tfsm_plaink3Package.TRACED_STATE__ORIGINAL_OBJECT:
