...
public class EventGuardAdapter extends EObjectAdapter<EventGuard> implements org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.EventGuard {
  ...
  public void setTriggeringEvent(final FSMEvent o) {
    if (o != null)
    	adaptee.setTriggeringEvent(((org.gemoc.sample.tfsm.sequential.xtfsm.adapters.xtfsmmt.tfsm.FSMEventAdapter) o).getAdaptee());
    else adaptee.setTriggeringEvent(null);
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.EventGuardVisitorAspect.visit(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.eINSTANCE.getEventGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.EVENT_GUARD__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.EVENT_GUARD__TRIGGERING_EVENT:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.EVENT_GUARD__TRIGGERING_EVENT:
    		setTriggeringEvent(
    		(org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.FSMEvent)
    		 newValue);
    		return;
    }
