...
public class FSMEventAdapter extends EObjectAdapter<FSMEvent> implements org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.FSMEvent {
  ...
  public boolean isIsTriggered() {
    return org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMEventAspect.isTriggered(adaptee);
  }
  
  @Override
  public void setIsTriggered(final boolean isTriggered) {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMEventAspect.isTriggered(adaptee, isTriggered
    );
  }
  
  @Override
  public void trigger() {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMEventAspect.trigger(adaptee);
  }
  
  @Override
  public void unTrigger() {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.FSMEventAspect.unTrigger(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.eINSTANCE.getFSMEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.FSM_EVENT__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.FSM_EVENT__SOLLICITING_TRANSITIONS:
    		return getSollicitingTransitions();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.FSM_EVENT__IS_TRIGGERED:
