...
public class TimedSystemAdapter extends EObjectAdapter<TimedSystem> implements org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TimedSystem {
  ...
  public void initializeModel(final org.eclipse.emf.common.util.EList<java.lang.String> args) {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.TimedSystemAspect.initializeModel(adaptee, args
    );
  }
  
  @Override
  public void main() {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.TimedSystemAspect.main(adaptee);
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.tfsm.sequential.xtfsm.aspects.TimedSystemVisitorAspect.visit(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.eINSTANCE.getTimedSystem();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.TIMED_SYSTEM__NAME:
    		return getName();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.TIMED_SYSTEM__TFSMS:
    		return getTfsms();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.TIMED_SYSTEM__GLOBAL_CLOCKS:
    		return getGlobalClocks();
    	case org.gemoc.sample.tfsm.sequential.xtfsmmt.tfsm.TfsmPackage.TIMED_SYSTEM__GLOBAL_EVENTS:
