 ...
 *   <li>{@link tfsm_plaink3Trace.States.tfsm_plaink3.impl.TracedFSMEventImpl#getSollicitingTransitions <em>Solliciting Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TracedFSMEventImpl extends TracedNamedElementImpl implements TracedFSMEvent {
	...
	public EList<Transition> getSollicitingTransitions() {
		if (sollicitingTransitions == null) {
			sollicitingTransitions = new EObjectResolvingEList<Transition>(Transition.class, this, Tfsm_plaink3Package.TRACED_FSM_EVENT__SOLLICITING_TRANSITIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Tfsm_plaink3Package.TRACED_FSM_EVENT__SOLLICITING_TRANSITIONS:
