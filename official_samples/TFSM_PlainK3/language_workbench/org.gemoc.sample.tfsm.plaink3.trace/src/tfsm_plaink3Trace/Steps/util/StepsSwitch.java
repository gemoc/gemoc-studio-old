	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.TFSM_PLAINK3_FSM_CLOCK_TICKS: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_FSMClock_Ticks);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_FSM_EVENT_TRIGGER: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_FSMEvent_Trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_FSM_EVENT_UN_TRIGGER: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_FSMEvent_UnTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_STATE_VISIT: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_State_Visit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StepsPackage.TFSM_PLAINK3_STATE_VISIT_IMPLICIT_STEP: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_State_Visit_ImplicitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_TFSM_INIT: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_TFSM_Init);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_TRANSITION_FIRE: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_Transition_Fire);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.TFSM_PLAINK3_TRANSITION_VISIT: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_Transition_Visit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StepsPackage.TFSM_PLAINK3_TRANSITION_VISIT_IMPLICIT_STEP: {
				...
				if (result == null) result = caseMSEOccurrence(tfsm_plaink3_Transition_Visit_ImplicitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
