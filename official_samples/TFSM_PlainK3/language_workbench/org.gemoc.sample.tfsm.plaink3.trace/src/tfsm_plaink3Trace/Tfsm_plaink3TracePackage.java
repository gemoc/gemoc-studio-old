...
public interface Tfsm_plaink3TracePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Tfsm plaink3 traced Named Elements</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRACE__TFSM_PLAINK3_TRACED_NAMED_ELEMENTS = 11;
	 ...
	 * @ordered
	 */
	int TRACE__TFSM_PLAINK3_TRACED_TFS_MS = 12;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link tfsm_plaink3Trace.Trace#getTfsm_plaink3_tracedNamedElements <em>Tfsm plaink3 traced Named Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Tfsm plaink3 traced Named Elements</em>'.
	 * @see tfsm_plaink3Trace.Trace#getTfsm_plaink3_tracedNamedElements()
	 * @see #getTrace()
	 * @generated
	 */
	EReference getTrace_Tfsm_plaink3_tracedNamedElements();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Tfsm plaink3 traced Named Elements</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference TRACE__TFSM_PLAINK3_TRACED_NAMED_ELEMENTS = eINSTANCE.getTrace_Tfsm_plaink3_tracedNamedElements();
