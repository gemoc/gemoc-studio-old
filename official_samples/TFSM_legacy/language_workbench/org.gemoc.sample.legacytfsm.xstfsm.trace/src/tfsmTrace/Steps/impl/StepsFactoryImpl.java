...
public class StepsFactoryImpl extends EFactoryImpl implements StepsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StepsPackage.TFSM_TIME_FSM_INIT: return createTfsm_TimeFSM_Init();
	 ...
	 * @generated
	 */
	public Tfsm_TimeFSM_Init createTfsm_TimeFSM_Init() {
		Tfsm_TimeFSM_InitImpl tfsm_TimeFSM_Init = new Tfsm_TimeFSM_InitImpl();
		return tfsm_TimeFSM_Init;
	}
