...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	 ...
	 * @generated
	 */
	private EClass tfsm_TimeFSM_InitEClass = null;
	 ...
	 * @generated
	 */
	public EClass getTfsm_TimeFSM_Init() {
		return tfsm_TimeFSM_InitEClass;
	}
	...
	public void createPackageContents() {
		...
		tfsm_TimeFSM_InitEClass = createEClass(TFSM_TIME_FSM_INIT);
	...
	public void initializePackageContents() {
		...
		tfsm_TimeFSM_InitEClass.getESuperTypes().add(this.getSpecificStep());
		tfsm_TimeFSM_InitEClass.getESuperTypes().add(theTracePackage.getSmallStep());
		...
		initEClass(tfsm_TimeFSM_InitEClass, Tfsm_TimeFSM_Init.class, "Tfsm_TimeFSM_Init", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(tfsm_TimeFSM_InitEClass, theTfsmPackage_1.getTracedTimeFSM(), "getCaller", 1, 1, IS_UNIQUE, IS_ORDERED);
