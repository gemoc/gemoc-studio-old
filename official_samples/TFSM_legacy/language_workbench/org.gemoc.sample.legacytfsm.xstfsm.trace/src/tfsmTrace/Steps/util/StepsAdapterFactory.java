...
public class StepsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StepsSwitch<Adapter> modelSwitch =
		new StepsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTfsm_TimeFSM_Init(Tfsm_TimeFSM_Init object) {
				return createTfsm_TimeFSM_InitAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tfsmTrace.Steps.Tfsm_TimeFSM_Init <em>Tfsm Time FSM Init</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTfsm_TimeFSM_InitAdapter() {
		return null;
	}
