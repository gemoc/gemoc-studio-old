...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.TFSM_TIME_FSM_INIT: {
				Tfsm_TimeFSM_Init tfsm_TimeFSM_Init = (Tfsm_TimeFSM_Init)theEObject;
				T result = caseTfsm_TimeFSM_Init(tfsm_TimeFSM_Init);
				if (result == null) result = caseSpecificStep(tfsm_TimeFSM_Init);
				if (result == null) result = caseSmallStep(tfsm_TimeFSM_Init);
				if (result == null) result = caseStep(tfsm_TimeFSM_Init);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tfsm Time FSM Init</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tfsm Time FSM Init</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTfsm_TimeFSM_Init(Tfsm_TimeFSM_Init object) {
		return null;
	}
