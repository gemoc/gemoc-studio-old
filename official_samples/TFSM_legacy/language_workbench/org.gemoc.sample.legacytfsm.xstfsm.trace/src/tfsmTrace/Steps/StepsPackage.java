...
public interface StepsPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link tfsmTrace.Steps.impl.Tfsm_TimeFSM_InitImpl <em>Tfsm Time FSM Init</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tfsmTrace.Steps.impl.Tfsm_TimeFSM_InitImpl
	 * @see tfsmTrace.Steps.impl.StepsPackageImpl#getTfsm_TimeFSM_Init()
	 * @generated
	 */
	int TFSM_TIME_FSM_INIT = 8;
	 ...
	 * @ordered
	 */
	int TFSM_TIME_FSM_INIT__MSEOCCURRENCE = SPECIFIC_STEP__MSEOCCURRENCE;
	 ...
	 * @ordered
	 */
	int TFSM_TIME_FSM_INIT__ENDING_STATE = SPECIFIC_STEP__ENDING_STATE;
	 ...
	 * @ordered
	 */
	int TFSM_TIME_FSM_INIT__STARTING_STATE = SPECIFIC_STEP__STARTING_STATE;

	/**
	 * The number of structural features of the '<em>Tfsm Time FSM Init</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TFSM_TIME_FSM_INIT_FEATURE_COUNT = SPECIFIC_STEP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TFSM_TRANSITION_VISIT__MSEOCCURRENCE = TFSM_STATE_VISIT_ABSTRACT_SUB_STEP__MSEOCCURRENCE;
	 ...
	 * @ordered
	 */
	int TFSM_TRANSITION_VISIT__ENDING_STATE = TFSM_STATE_VISIT_ABSTRACT_SUB_STEP__ENDING_STATE;
	 ...
	 * @ordered
	 */
	int TFSM_TRANSITION_VISIT__STARTING_STATE = TFSM_STATE_VISIT_ABSTRACT_SUB_STEP__STARTING_STATE;
	 ...
	 * @ordered
	 */
	int TFSM_TRANSITION_VISIT__SUB_STEPS = TFSM_STATE_VISIT_ABSTRACT_SUB_STEP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TFSM_TRANSITION_VISIT_FEATURE_COUNT = TFSM_STATE_VISIT_ABSTRACT_SUB_STEP_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for class '{@link tfsmTrace.Steps.Tfsm_TimeFSM_Init <em>Tfsm Time FSM Init</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Tfsm Time FSM Init</em>'.
	 * @see tfsmTrace.Steps.Tfsm_TimeFSM_Init
	 * @generated
	 */
	EClass getTfsm_TimeFSM_Init();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link tfsmTrace.Steps.impl.Tfsm_TimeFSM_InitImpl <em>Tfsm Time FSM Init</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tfsmTrace.Steps.impl.Tfsm_TimeFSM_InitImpl
		 * @see tfsmTrace.Steps.impl.StepsPackageImpl#getTfsm_TimeFSM_Init()
		 * @generated
		 */
		EClass TFSM_TIME_FSM_INIT = eINSTANCE.getTfsm_TimeFSM_Init();
