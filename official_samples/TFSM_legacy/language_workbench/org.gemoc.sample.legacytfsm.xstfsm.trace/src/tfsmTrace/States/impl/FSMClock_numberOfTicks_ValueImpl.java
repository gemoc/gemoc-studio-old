 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.FSMClock_numberOfTicks_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMClock_numberOfTicks_ValueImpl#getNumberOfTicks <em>Number Of Ticks</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMClock_numberOfTicks_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.FSMClock_numberOfTicks_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FSMClock_numberOfTicks_ValueImpl extends MinimalEObjectImpl.Container implements FSMClock_numberOfTicks_Value {
	...
	public void setParent(TracedFSMClock newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.FSM_CLOCK_NUMBER_OF_TICKS_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_FSM_CLOCK__NUMBER_OF_TICKS_SEQUENCE, TracedFSMClock.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.FSM_CLOCK_NUMBER_OF_TICKS_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_FSM_CLOCK__NUMBER_OF_TICKS_SEQUENCE, TracedFSMClock.class, msgs);
		}
