 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.TimeFSM_lastStateChangeStepNumber_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TimeFSM_lastStateChangeStepNumber_ValueImpl#getLastStateChangeStepNumber <em>Last State Change Step Number</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TimeFSM_lastStateChangeStepNumber_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.TimeFSM_lastStateChangeStepNumber_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeFSM_lastStateChangeStepNumber_ValueImpl extends MinimalEObjectImpl.Container implements TimeFSM_lastStateChangeStepNumber_Value {
	...
	public void setParent(TracedTimeFSM newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TIME_FSM_LAST_STATE_CHANGE_STEP_NUMBER_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, TfsmPackage.TRACED_TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER_SEQUENCE, TracedTimeFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TIME_FSM_LAST_STATE_CHANGE_STEP_NUMBER_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TRACED_TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER_SEQUENCE, TracedTimeFSM.class, msgs);
		}
