 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getEndedSteps <em>Ended Steps</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getFSMClock_numberOfTicks_Values <em>FSM Clock number Of Ticks Values</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getFSMEvent_isTriggered_Values <em>FSM Event is Triggered Values</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getStartedSteps <em>Started Steps</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getTimeFSM_currentState_Values <em>Time FSM current State Values</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getTimeFSM_lastStateChangeStepNumber_Values <em>Time FSM last State Change Step Number Values</em>}</li>
 *   <li>{@link tfsmTrace.States.impl.StateImpl#getTimeFSM_stepNumber_Values <em>Time FSM step Number Values</em>}</li>
 * </ul>
 *
 * @generated
 */
