 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.tfsm.impl.TracedFSMClockImpl#getNumberOfTicksSequence <em>Number Of Ticks Sequence</em>}</li>
 *   <li>{@link tfsmTrace.States.tfsm.impl.TracedFSMClockImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedFSMClockImpl extends TracedNamedElementImpl implements TracedFSMClock {
	...
	protected EClass eStaticClass() {
		return TfsmPackage.Literals.TRACED_FSM_CLOCK;
	}
	...
	public EList<FSMClock_numberOfTicks_Value> getNumberOfTicksSequence() {
		if (numberOfTicksSequence == null) {
			numberOfTicksSequence = new EObjectContainmentWithInverseEList<FSMClock_numberOfTicks_Value>(FSMClock_numberOfTicks_Value.class, this, TfsmPackage.TRACED_FSM_CLOCK__NUMBER_OF_TICKS_SEQUENCE, StatesPackage.FSM_CLOCK_NUMBER_OF_TICKS_VALUE__PARENT);
		}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TfsmPackage.TRACED_FSM_CLOCK__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(FSMClock newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRACED_FSM_CLOCK__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TfsmPackage.TRACED_FSM_CLOCK__NUMBER_OF_TICKS_SEQUENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmPackage.TRACED_FSM_CLOCK__ORIGINAL_OBJECT:
