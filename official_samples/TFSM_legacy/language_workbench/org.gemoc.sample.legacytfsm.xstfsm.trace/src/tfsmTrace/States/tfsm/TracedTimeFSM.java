 ...
 * </p>
 * <ul>
 *   <li>{@link tfsmTrace.States.tfsm.TracedTimeFSM#getCurrentStateSequence <em>Current State Sequence</em>}</li>
 *   <li>{@link tfsmTrace.States.tfsm.TracedTimeFSM#getLastStateChangeStepNumberSequence <em>Last State Change Step Number Sequence</em>}</li>
 *   <li>{@link tfsmTrace.States.tfsm.TracedTimeFSM#getOriginalObject <em>Original Object</em>}</li>
 *   <li>{@link tfsmTrace.States.tfsm.TracedTimeFSM#getStepNumberSequence <em>Step Number Sequence</em>}</li>
 * </ul>
 *
 * @see tfsmTrace.States.tfsm.TfsmPackage#getTracedTimeFSM()
 * @model
 * @generated
 */
public interface TracedTimeFSM extends TracedNamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TimeFSM_currentState_Value#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.tfsm.TfsmPackage#getTracedTimeFSM_CurrentStateSequence()
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TimeFSM_lastStateChangeStepNumber_Value#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.tfsm.TfsmPackage#getTracedTimeFSM_LastStateChangeStepNumberSequence()
	 ...
	 * @see tfsmTrace.States.tfsm.TfsmPackage#getTracedTimeFSM_OriginalObject()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link tfsmTrace.States.tfsm.TracedTimeFSM#getOriginalObject <em>Original Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link tfsmTrace.States.TimeFSM_stepNumber_Value#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tfsmTrace.States.tfsm.TfsmPackage#getTracedTimeFSM_StepNumberSequence()
