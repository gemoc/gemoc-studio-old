...
public class TfsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TfsmPackage.TRACED_EVALUATE_GUARD: {
			...
			case TfsmPackage.TRACED_EVENT_GUARD: {
			...
			case TfsmPackage.TRACED_FSM_CLOCK: {
			...
			case TfsmPackage.TRACED_FSM_EVENT: {
			...
			case TfsmPackage.TRACED_TEMPORAL_GUARD: {
			...
			case TfsmPackage.TRACED_TIME_FSM: {
			...
			case TfsmPackage.TRACED_TIMED_SYSTEM: {
			...
			case TfsmPackage.TRACED_TRANSITION: {
