 ...
 *   <li>{@link tfsmTrace.SpecificTrace#getTfsm_TimeFSM_Init_Sequence <em>Tfsm Time FSM Init Sequence</em>}</li>
 ...
 *   <li>{@link tfsmTrace.SpecificTrace#getTfsm_tracedTimeFSMs <em>Tfsm traced Time FS Ms</em>}</li>
...
public interface SpecificTrace extends Trace<SequentialStep<SpecificStep>> {
	...
	/**
	 * Returns the value of the '<em><b>Tfsm Time FSM Init Sequence</b></em>' reference list.
	 * The list contents are of type {@link tfsmTrace.Steps.Tfsm_TimeFSM_Init}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Tfsm Time FSM Init Sequence</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Tfsm Time FSM Init Sequence</em>' reference list.
	 * @see tfsmTrace.TfsmTracePackage#getSpecificTrace_Tfsm_TimeFSM_Init_Sequence()
	 * @model
	 * @generated
	 */
	EList<Tfsm_TimeFSM_Init> getTfsm_TimeFSM_Init_Sequence();
	...
	/**
	 * Returns the value of the '<em><b>Tfsm traced Time FS Ms</b></em>' containment reference list.
	 * The list contents are of type {@link tfsmTrace.States.tfsm.TracedTimeFSM}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Tfsm traced Time FS Ms</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Tfsm traced Time FS Ms</em>' containment reference list.
	 * @see tfsmTrace.TfsmTracePackage#getSpecificTrace_Tfsm_tracedTimeFSMs()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	EList<TracedTimeFSM> getTfsm_tracedTimeFSMs();
