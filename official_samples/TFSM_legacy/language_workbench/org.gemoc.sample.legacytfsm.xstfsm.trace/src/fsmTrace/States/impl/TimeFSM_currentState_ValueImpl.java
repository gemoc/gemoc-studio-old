 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.impl.TimeFSM_currentState_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fsmTrace.States.impl.TimeFSM_currentState_ValueImpl#getCurrentState <em>Current State</em>}</li>
 *   <li>{@link fsmTrace.States.impl.TimeFSM_currentState_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fsmTrace.States.impl.TimeFSM_currentState_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeFSM_currentState_ValueImpl extends MinimalEObjectImpl.Container implements TimeFSM_currentState_Value {
	...
	public void setParent(TracedTimeFSM newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TIME_FSM_CURRENT_STATE_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, FsmPackage.TRACED_TIME_FSM__CURRENT_STATE_SEQUENCE, TracedTimeFSM.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TIME_FSM_CURRENT_STATE_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, FsmPackage.TRACED_TIME_FSM__CURRENT_STATE_SEQUENCE, TracedTimeFSM.class, msgs);
		}
