 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedTemporalGuardImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedTemporalGuardImpl extends TracedGuardImpl implements TracedTemporalGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TRACED_TEMPORAL_GUARD;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRACED_TEMPORAL_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(TemporalGuard newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRACED_TEMPORAL_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.TRACED_TEMPORAL_GUARD__ORIGINAL_OBJECT:
