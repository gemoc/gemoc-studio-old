 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.fsm.impl.TracedEvaluateGuardImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedEvaluateGuardImpl extends TracedGuardImpl implements TracedEvaluateGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TRACED_EVALUATE_GUARD;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRACED_EVALUATE_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(EvaluateGuard newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRACED_EVALUATE_GUARD__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.TRACED_EVALUATE_GUARD__ORIGINAL_OBJECT:
