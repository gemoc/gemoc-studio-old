...
public class TfsmTraceConstructor implements ITraceConstructor {
		...
		if (lastState == null) {
			...
			for (Resource r : allResources) {
				for (TreeIterator<EObject> i = r.getAllContents(); i.hasNext();) {
					...
					if (o instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.NamedElement) {
						org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.NamedElement o_cast = (org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.NamedElement) o;
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EvaluateGuard o_cast,
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EvaluateGuard) o_cast);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EventGuard o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EventGuard) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.FSMClock o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.FSMClock) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.FSMEvent o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.FSMEvent) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.Guard o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		if (o_cast instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EventGuard) {
			added = addNewObjectToState((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EventGuard) o_cast, newState);
		} else if (o_cast instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TemporalGuard) {
			added = addNewObjectToState((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TemporalGuard) o_cast,
					newState);
		} else if (o_cast instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EvaluateGuard) {
			added = addNewObjectToState((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.EvaluateGuard) o_cast,
					newState);
		}
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.NamedElement o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		if (o_cast instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimeFSM) {
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.State o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			tfsmTrace.States.tfsm.TracedState tracedObject = tfsmTrace.States.tfsm.TfsmFactory.eINSTANCE
					.createTracedState();
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.State) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TemporalGuard o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TemporalGuard) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimeFSM o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;

		if (!added && !exeToTraced.containsKey(o_cast)) {
			tfsmTrace.States.tfsm.TracedTimeFSM tracedObject = tfsmTrace.States.tfsm.TfsmFactory.eINSTANCE
					.createTracedTimeFSM();
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimeFSM) o_cast);
			exeToTraced.put(o_cast, tracedObject);
			traceRoot.getTfsm_tracedTimeFSMs().add(tracedObject);

			// Creation of the first value of the field currentState
			tfsmTrace.States.TimeFSM_currentState_Value firstValue_currentState = tfsmTrace.States.StatesFactory.eINSTANCE
					.createTimeFSM_currentState_Value();

			if (o_cast.getCurrentState() != null) {
				addNewObjectToState((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.State) o_cast.getCurrentState(),
						newState);
			...
			tfsmTrace.States.TimeFSM_lastStateChangeStepNumber_Value firstValue_lastStateChangeStepNumber = tfsmTrace.States.StatesFactory.eINSTANCE
			...
			tfsmTrace.States.TimeFSM_stepNumber_Value firstValue_stepNumber = tfsmTrace.States.StatesFactory.eINSTANCE
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimedSystem o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimedSystem) o_cast);
			exeToTraced.put(o_cast, tracedObject);
	...
	private boolean addNewObjectToState(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.Transition o_cast,
			tfsmTrace.States.State newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.Transition) o_cast);
			exeToTraced.put(o_cast, tracedObject);
					...
					if (o instanceof org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TimeFSM) {
						...
						if (p.getFeatureID() == org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.TfsmPackage.eINSTANCE
							...
							tfsmTrace.States.tfsm.TracedTimeFSM traced = (tfsmTrace.States.tfsm.TracedTimeFSM) exeToTraced
									.get(o);
							tfsmTrace.States.TimeFSM_currentState_Value lastValue = traced.getCurrentStateSequence()
									.get(traced.getCurrentStateSequence().size() - 1);
							newState.getTimeFSM_currentState_Values().remove(lastValue);

							// And we create a proper new value
							tfsmTrace.States.TimeFSM_currentState_Value newValue = tfsmTrace.States.StatesFactory.eINSTANCE
									.createTimeFSM_currentState_Value();
	...
	public void addStep(fr.inria.diverse.trace.commons.model.trace.Step step) {
		...
		if (step != null && step instanceof tfsmTrace.Steps.SpecificStep) {
			...
			} else if (step_cast instanceof tfsmTrace.Steps.Tfsm_TimeFSM_Init) {
				tfsmTrace.Steps.Tfsm_TimeFSM_Init tfsm_TimeFSM_InitInstance = (tfsmTrace.Steps.Tfsm_TimeFSM_Init) step_cast;
				traceRoot.getTfsm_TimeFSM_Init_Sequence().add(tfsm_TimeFSM_InitInstance);
