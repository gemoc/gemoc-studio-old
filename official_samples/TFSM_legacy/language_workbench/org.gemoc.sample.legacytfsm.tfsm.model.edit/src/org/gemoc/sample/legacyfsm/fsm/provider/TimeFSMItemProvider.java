...
/**
 * This is the item provider adapter for a {@link org.gemoc.sample.legacyfsm.fsm.TimeFSM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeFSMItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsmPackage.Literals.TIME_FSM__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.TIME_FSM__OWNED_STATES);
			childrenFeatures.add(FsmPackage.Literals.TIME_FSM__LOCAL_EVENTS);
			childrenFeatures.add(FsmPackage.Literals.TIME_FSM__LOCAL_CLOCK);
			childrenFeatures.add(FsmPackage.Literals.TIME_FSM__OWNED_TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TIME_FSM__OWNED_STATES,
				 FsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TIME_FSM__LOCAL_EVENTS,
				 FsmFactory.eINSTANCE.createFSMEvent()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TIME_FSM__LOCAL_CLOCK,
				 FsmFactory.eINSTANCE.createFSMClock()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TIME_FSM__OWNED_TRANSITIONS,
