 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getOwnedStates <em>Owned States</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getInitialState <em>Initial State</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getLocalEvents <em>Local Events</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getLocalClock <em>Local Clock</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getOwnedTransitions <em>Owned Transitions</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getStepNumber <em>Step Number</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getLastStateChangeStepNumber <em>Last State Change Step Number</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TimeFSMImpl#getCurrentState <em>Current State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeFSMImpl extends NamedElementImpl implements TimeFSM {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TIME_FSM;
	}
	...
	public EList<State> getOwnedStates() {
		if (ownedStates == null) {
			ownedStates = new EObjectContainmentWithInverseEList<State>(State.class, this, FsmPackage.TIME_FSM__OWNED_STATES, FsmPackage.STATE__OWNING_FSM);
		}
		return ownedStates;
	}
		...
		if (initialState != null && initialState.eIsProxy()) {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TIME_FSM__INITIAL_STATE, oldInitialState, initialState));
			}
		}
		return initialState;
	}
	...
	public void setInitialState(State newInitialState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__INITIAL_STATE, oldInitialState, initialState));
	}
	...
	public EList<FSMEvent> getLocalEvents() {
		if (localEvents == null) {
			localEvents = new EObjectContainmentEList<FSMEvent>(FSMEvent.class, this, FsmPackage.TIME_FSM__LOCAL_EVENTS);
		}
		return localEvents;
	}
	...
	public NotificationChain basicSetLocalClock(FSMClock newLocalClock, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__LOCAL_CLOCK, oldLocalClock, newLocalClock);
	...
	public void setLocalClock(FSMClock newLocalClock) {
		if (newLocalClock != localClock) {
			...
			if (localClock != null)
				msgs = ((InternalEObject)localClock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FsmPackage.TIME_FSM__LOCAL_CLOCK, null, msgs);
			if (newLocalClock != null)
				msgs = ((InternalEObject)newLocalClock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FsmPackage.TIME_FSM__LOCAL_CLOCK, null, msgs);
			msgs = basicSetLocalClock(newLocalClock, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__LOCAL_CLOCK, newLocalClock, newLocalClock));
	}
	...
	public EList<Transition> getOwnedTransitions() {
		if (ownedTransitions == null) {
			ownedTransitions = new EObjectContainmentEList<Transition>(Transition.class, this, FsmPackage.TIME_FSM__OWNED_TRANSITIONS);
		}
	...
	public void setStepNumber(int newStepNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__STEP_NUMBER, oldStepNumber, stepNumber));
	}
	...
	public void setLastStateChangeStepNumber(int newLastStateChangeStepNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER, oldLastStateChangeStepNumber, lastStateChangeStepNumber));
	}
	...
	public State getCurrentState() {
		if (currentState != null && currentState.eIsProxy()) {
			...
			if (currentState != oldCurrentState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TIME_FSM__CURRENT_STATE, oldCurrentState, currentState));
			}
		}
		return currentState;
	}
	...
	public void setCurrentState(State newCurrentState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TIME_FSM__CURRENT_STATE, oldCurrentState, currentState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FsmPackage.TIME_FSM__OWNED_STATES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FsmPackage.TIME_FSM__LOCAL_EVENTS:
				return ((InternalEList<?>)getLocalEvents()).basicRemove(otherEnd, msgs);
			case FsmPackage.TIME_FSM__LOCAL_CLOCK:
				return basicSetLocalClock(null, msgs);
			case FsmPackage.TIME_FSM__OWNED_TRANSITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FsmPackage.TIME_FSM__INITIAL_STATE:
			...
			case FsmPackage.TIME_FSM__STEP_NUMBER:
				return getStepNumber();
			case FsmPackage.TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER:
				return getLastStateChangeStepNumber();
			case FsmPackage.TIME_FSM__CURRENT_STATE:
