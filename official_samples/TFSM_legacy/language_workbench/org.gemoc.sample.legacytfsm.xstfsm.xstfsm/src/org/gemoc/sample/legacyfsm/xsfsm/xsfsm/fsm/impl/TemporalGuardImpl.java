 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TemporalGuardImpl#getOnClock <em>On Clock</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.TemporalGuardImpl#getAfterDuration <em>After Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemporalGuardImpl extends GuardImpl implements TemporalGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.TEMPORAL_GUARD;
	}
		...
		if (onClock != null && onClock.eIsProxy()) {
			...
			if (onClock != oldOnClock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TEMPORAL_GUARD__ON_CLOCK, oldOnClock, onClock));
			}
		}
		return onClock;
	}
	...
	public void setOnClock(FSMClock newOnClock) {
		...
		onClock = newOnClock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TEMPORAL_GUARD__ON_CLOCK, oldOnClock, onClock));
	}
	...
	public void setAfterDuration(int newAfterDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TEMPORAL_GUARD__AFTER_DURATION, oldAfterDuration, afterDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.TEMPORAL_GUARD__ON_CLOCK:
				if (resolve) return getOnClock();
				return basicGetOnClock();
			case FsmPackage.TEMPORAL_GUARD__AFTER_DURATION:
