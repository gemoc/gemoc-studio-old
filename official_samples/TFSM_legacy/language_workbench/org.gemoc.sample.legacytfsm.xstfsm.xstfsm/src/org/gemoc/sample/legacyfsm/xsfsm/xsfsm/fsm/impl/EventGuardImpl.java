 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.EventGuardImpl#getTriggeringEvent <em>Triggering Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventGuardImpl extends GuardImpl implements EventGuard {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.EVENT_GUARD;
	}
		...
		if (triggeringEvent != null && triggeringEvent.eIsProxy()) {
			...
			if (triggeringEvent != oldTriggeringEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
			}
		}
	...
	public void setTriggeringEvent(FSMEvent newTriggeringEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.EVENT_GUARD__TRIGGERING_EVENT, oldTriggeringEvent, triggeringEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.EVENT_GUARD__TRIGGERING_EVENT:
