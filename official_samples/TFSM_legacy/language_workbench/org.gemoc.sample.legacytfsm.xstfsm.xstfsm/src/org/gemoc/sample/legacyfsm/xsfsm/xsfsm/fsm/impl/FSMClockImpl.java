 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.xsfsm.xsfsm.fsm.impl.FSMClockImpl#getNumberOfTicks <em>Number Of Ticks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FSMClockImpl extends NamedElementImpl implements FSMClock {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.FSM_CLOCK;
	}
	...
	public void setNumberOfTicks(Integer newNumberOfTicks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.FSM_CLOCK__NUMBER_OF_TICKS, oldNumberOfTicks, numberOfTicks));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.FSM_CLOCK__NUMBER_OF_TICKS:
