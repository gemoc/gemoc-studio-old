...
public class TimedFSMAdapter extends EObjectAdapter<TimedFSM> implements org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TimedFSM {
  ...
  public void setInitialState(final State o) {
    if (o != null)
    	adaptee.setInitialState(((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.adapters.xstfsmmt.tfsm.StateAdapter) o).getAdaptee());
  ...
  public void setLocalClock(final FSMClock o) {
    if (o != null)
    	adaptee.setLocalClock(((org.gemoc.sample.legacytfsm.xstfsm.xstfsm.adapters.xstfsmmt.tfsm.FSMClockAdapter) o).getAdaptee());
  ...
  public int getLastStateChangeStepNumber() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMVisitorAspect.lastStateChangeStepNumber(adaptee);
  }
  
  @Override
  public void setLastStateChangeStepNumber(final int lastStateChangeStepNumber) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMVisitorAspect.lastStateChangeStepNumber(adaptee, lastStateChangeStepNumber
    );
  }
  
  @Override
  public int getStepNumber() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMVisitorAspect.stepNumber(adaptee);
  }
  
  @Override
  public void setStepNumber(final int stepNumber) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMVisitorAspect.stepNumber(adaptee, stepNumber
    );
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMVisitorAspect.visit(adaptee);
  }
  
  @Override
  public State getCurrentState() {
    return (State) adaptersFactory.createAdapter(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMAspect.currentState(adaptee), eResource);
  }
  
  @Override
  public void setCurrentState(final State currentState) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMAspect.currentState(adaptee, (org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.State)((EObjectAdapter)currentState).getAdaptee()
    );
  }
  
  @Override
  public void init() {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimedFSMAspect.init(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.eINSTANCE.getTimedFSM();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__NAME:
    		return getName();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__OWNED_STATES:
    		return getOwnedStates();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__INITIAL_STATE:
    		return getInitialState();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__LOCAL_EVENTS:
    		return getLocalEvents();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__LOCAL_CLOCK:
    		return getLocalClock();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__OWNED_TRANSITIONS:
    		return getOwnedTransitions();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__STEP_NUMBER:
    		return new java.lang.Integer(getStepNumber());
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__LAST_STATE_CHANGE_STEP_NUMBER:
    		return new java.lang.Integer(getLastStateChangeStepNumber());
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__CURRENT_STATE:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__INITIAL_STATE:
    		setInitialState(
    		(org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.State)
    		 newValue);
    		return;
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__LOCAL_EVENTS:
    	...
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__LOCAL_CLOCK:
    		setLocalClock(
    		(org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.FSMClock)
    		 newValue);
    		return;
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIMED_FSM__OWNED_TRANSITIONS:
