...
public class TemporalGuardAdapter extends EObjectAdapter<TemporalGuard> implements org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.TemporalGuard {
  ...
  public void setOnClock(final FSMClock o) {
    if (o != null)
    	adaptee.setOnClock(((org.gemoc.sample.legacyfsm.xsfsm.xsfsm.adapters.xsfsmmt.fsm.FSMClockAdapter) o).getAdaptee());
    else adaptee.setOnClock(null);
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.TemporalGuardVisitorAspect.visit(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.eINSTANCE.getTemporalGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TEMPORAL_GUARD__NAME:
    		return getName();
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TEMPORAL_GUARD__ON_CLOCK:
    		return getOnClock();
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TEMPORAL_GUARD__AFTER_DURATION:
