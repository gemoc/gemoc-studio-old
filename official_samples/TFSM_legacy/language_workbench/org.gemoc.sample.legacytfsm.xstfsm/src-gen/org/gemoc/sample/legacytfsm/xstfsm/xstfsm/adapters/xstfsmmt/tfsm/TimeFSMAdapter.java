...
public class TimeFSMAdapter extends EObjectAdapter<TimeFSM> implements org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TimeFSM {
  ...
  public int getLastStateChangeStepNumber() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMVisitorAspect.lastStateChangeStepNumber(adaptee);
  }
  
  @Override
  public void setLastStateChangeStepNumber(final int lastStateChangeStepNumber) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMVisitorAspect.lastStateChangeStepNumber(adaptee, lastStateChangeStepNumber
    );
  }
  
  @Override
  public int getStepNumber() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMVisitorAspect.stepNumber(adaptee);
  }
  
  @Override
  public void setStepNumber(final int stepNumber) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMVisitorAspect.stepNumber(adaptee, stepNumber
    );
  }
  
  @Override
  public void visit() {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMVisitorAspect.visit(adaptee);
  }
  
  @Override
  public State getCurrentState() {
    return (State) adaptersFactory.createAdapter(org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMAspect.currentState(adaptee), eResource);
  }
  
  @Override
  public void setCurrentState(final State currentState) {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMAspect.currentState(adaptee, (org.gemoc.sample.legacytfsm.xstfsm.xstfsm.tfsm.State)((EObjectAdapter)currentState).getAdaptee()
    );
  }
  
  @Override
  public void init() {
    org.gemoc.sample.legacytfsm.xstfsm.xstfsm.aspects.TimeFSMAspect.init(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.eINSTANCE.getTimeFSM();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__NAME:
    		return getName();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__OWNED_STATES:
    		return getOwnedStates();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__INITIAL_STATE:
    		return getInitialState();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__LOCAL_EVENTS:
    		return getLocalEvents();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__LOCAL_CLOCK:
    		return getLocalClock();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__OWNED_TRANSITIONS:
    		return getOwnedTransitions();
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__STEP_NUMBER:
    		return new java.lang.Integer(getStepNumber());
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__LAST_STATE_CHANGE_STEP_NUMBER:
    		return new java.lang.Integer(getLastStateChangeStepNumber());
    	case org.gemoc.sample.legacytfsm.xstfsm.xstfsmmt.tfsm.TfsmPackage.TIME_FSM__CURRENT_STATE:
